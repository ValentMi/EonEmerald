...
extern const u8 gTowerMaleFacilityClasses[51];
extern const u8 gTowerMaleTrainerGfxIds[51];
extern const u8 gTowerFemaleFacilityClasses[32];
extern const u8 gTowerFemaleTrainerGfxIds[32];
