...
#define GAME_VERSION_FIRERED (VERSION_FIRE_RED)
#define GAME_VERSION_LEAFGREEN (VERSION_LEAF_GREEN)
#define GAME_VERSION_RUBY (VERSION_RUBY)
#define GAME_VERSION_SAPPHIRE (VERSION_SAPPHIRE)
