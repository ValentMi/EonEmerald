...
extern const u8 gTypeEffectivenessInverse[372]; // 3 elements for each entry in the table (124 entries * 3 = 372).elements for each entry in the table (124 entries * 3 = 372).
