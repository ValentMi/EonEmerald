...
extern const u8 gText_RhydonDoll128BP[];
...
extern const u8 gText_RARE_CANDY1BP[];
extern const u8 gText_HEART_SCALE1BP[];
extern const u8 gText_PP_MAX4BP[];
...
extern const u8 gText_CHOICE_SPECS[];
extern const u8 gText_CHOICE_SCARF[];
extern const u8 gText_FLAME_ORB[];
extern const u8 gText_TOXIC_ORB[];
extern const u8 gText_AIR_BALLOON[];
extern const u8 gText_ABSORB_BULB[];
extern const u8 gText_CELL_BATTERY[];
extern const u8 gText_MUSCLE_BAND[];
extern const u8 gText_WISE_GLASSES[];
extern const u8 gText_ASSAULT_VEST[];
extern const u8 gText_COMBAT_VEST[];
extern const u8 gText_EVERSTONE[];
extern const u8 gText_ELECTIRIZER[];
extern const u8 gText_MAGMARIZER[];
extern const u8 gText_STICK[];
extern const u8 gText_THICK_CLUB[];
extern const u8 gText_LUCKY_PUNCH[];
extern const u8 gText_SOOTHE_BELL[];
extern const u8 gText_METAL_COAT[];
extern const u8 gText_LUCKY_EGG[];
extern const u8 gText_EXP_SHARE[];
extern const u8 gText_SMOKE_BALL[];
extern const u8 gText_LIGHT_BALL[];
extern const u8 gText_DEEP_SEA_TOOTH[];
extern const u8 gText_DEEP_SEA_SCALE[];
extern const u8 gText_SOUL_DEW[];
...
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_CHOICE_SPECSDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_CHOICE_SCARFDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_FLAME_ORBDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_TOXIC_ORBDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_AIR_BALLOONDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_ABSORB_BULBDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_CELL_BATTERYDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_MUSCLE_BANDDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_WISE_GLASSESDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_ASSAULT_VESTDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_COMBAT_VESTDesc[];
...
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_THICK_CLUBDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_LUCKY_PUNCHDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_METAL_COATDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_LUCKY_EGGDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_SMOKE_BALLDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_LIGHT_BALLDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_DEEP_SEA_TOOTHDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_DEEP_SEA_SCALEDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_SOUL_DEWDesc[];
