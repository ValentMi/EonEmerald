...
gBattleScriptsForMoveEffects::
	...
	.4byte BattleScript_EffectSpecialDefenseDownHit2 @ EFFECT_UNUSED_60
	...
	.4byte BattleScript_EffectVoltSwitch			 @ EFFECT_VOLT_SWITCH
...
BattleScript_EffectToxic::
	...
	jumpifability BS_TARGET, ABILITY_EFFECT_SPORE, BattleScript_NotAffected
	jumpifability BS_TARGET, ABILITY_SHIELD_DUST, BattleScript_NotAffected
	jumpifstatus2 BS_TARGET, STATUS2_SUBSTITUTE, BattleScript_ButItFailed
...
BattleScript_EffectParalyze::
	...
	jumpifability BS_TARGET, ABILITY_RUN_AWAY, BattleScript_LimberProtected
	jumpifability BS_TARGET, ABILITY_SHIELD_DUST, BattleScript_NotAffected
	jumpifstatus2 BS_TARGET, STATUS2_SUBSTITUTE, BattleScript_ButItFailed
...
BattleScript_EffectSpite::
	...
	setstatchanger STAT_SPEED, 2, TRUE
	goto BattleScript2_EffectHit
BattleScript2_EffectHit::
	setmoveeffect MOVE_EFFECT_FLINCH | MOVE_EFFECT_CERTAIN
BattleScript2_HitFromAtkCanceler::
	attackcanceler
BattleScript2_HitFromAccCheck::
	accuracycheck BattleScript_PrintMoveMissed, ACC_CURR_MOVE
BattleScript2_HitFromAtkString::
	attackstring
	ppreduce
BattleScript2_HitFromCritCalc::
	critcalc
	damagecalc
	typecalc
	adjustnormaldamage
BattleScript2_HitFromAtkAnimation::
	attackanimation
	waitanimation
	effectivenesssound
	hitanimation BS_TARGET
	...
	seteffectwithchance
	tryfaintmon BS_TARGET
BattleScript2_EffectStatDown::
	attackcanceler
	jumpifstatus2 BS_TARGET, STATUS2_SUBSTITUTE, BattleScript_FailedFromAtkString
	accuracycheck BattleScript_PrintMoveMissed, ACC_CURR_MOVE
	attackstring
	ppreduce
	statbuffchange STAT_CHANGE_ALLOW_PTR, BattleScript2_MoveEnd
	jumpifbyte CMP_LESS_THAN, cMULTISTRING_CHOOSER, B_MSG_STAT_WONT_DECREASE, BattleScript2_StatDownDoAnim
	jumpifbyte CMP_EQUAL, cMULTISTRING_CHOOSER, B_MSG_STAT_FELL_EMPTY, BattleScript2_MoveEnd
	pause B_WAIT_TIME_SHORT
	goto BattleScript2_StatDownPrintString
BattleScript2_StatDownDoAnim::
	setgraphicalstatchangevalues
	playanimation BS_TARGET, B_ANIM_STATS_CHANGE, sB_ANIM_ARG1
BattleScript2_StatDownPrintString::
	printfromtable gStatDownStringIds
	waitmessage B_WAIT_TIME_LONG
BattleScript2_MoveEnd::
	moveendall
	end
...
BattleScript_EffectFacade::
	jumpifstatus BS_TARGET, STATUS1_POISON | STATUS1_BURN | STATUS1_SLEEP | STATUS1_FREEZE | STATUS1_PARALYSIS | STATUS1_TOXIC_POISON, BattleScript_FacadeDoubleDmg
	goto BattleScript_EffectHit
...
BattleScript_EffectCharge::
	...
	waitmessage B_WAIT_TIME_LONG
	jumpifstat BS_ATTACKER, CMP_LESS_THAN, STAT_SPDEF, MAX_STAT_STAGE, BattleScript_ChargeBoostDoMoveAnim
	jumpifstat BS_ATTACKER, CMP_EQUAL, STAT_ACC, MAX_STAT_STAGE, BattleScript_CantRaiseMultipleStats
BattleScript_ChargeBoostDoMoveAnim::
	setbyte sSTAT_ANIM_PLAYED, FALSE
	playstatchangeanimation BS_ATTACKER, BIT_SPDEF | BIT_DEF, 0
	setstatchanger STAT_SPDEF, 1, FALSE
	statbuffchange MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_ALLOW_PTR, BattleScript_ChargeBoostTryDef
	jumpifbyte CMP_EQUAL, cMULTISTRING_CHOOSER, B_MSG_STAT_WONT_INCREASE, BattleScript_ChargeBoostTryDef
	printfromtable gStatUpStringIds
	waitmessage B_WAIT_TIME_LONG
BattleScript_ChargeBoostTryDef::
	setstatchanger STAT_ACC, 2, FALSE
	statbuffchange MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_ALLOW_PTR, BattleScript_ChargeBoostEnd
	jumpifbyte CMP_EQUAL, cMULTISTRING_CHOOSER, B_MSG_STAT_WONT_INCREASE, BattleScript_ChargeBoostEnd
	printfromtable gStatUpStringIds
	waitmessage B_WAIT_TIME_LONG
BattleScript_ChargeBoostEnd::
	goto BattleScript_MoveEnd
...
BattleScript_IntimidateActivatesLoop:
	...
	jumpifability BS_TARGET, ABILITY_ROCK_BODY, BattleScript_IntimidatePrevented
	jumpifability BS_TARGET, ABILITY_PERMAFROST, BattleScript_IntimidatePrevented
	jumpifability BS_TARGET, ABILITY_GALVANIZED, BattleScript_IntimidatePrevented
	jumpifability BS_TARGET, ABILITY_OBLIVIOUS, BattleScript_IntimidatePrevented
	jumpifability BS_TARGET, ABILITY_WHITE_SMOKE, BattleScript_IntimidatePrevented
	jumpifability BS_TARGET, ITEM_SOOTHE_BELL, BattleScript_IntimidatePrevented
...
BattleScript_FlameOrb::
	call BattleScript_FlameOrbBurn
	end2
	
BattleScript_ToxicOrb::
	call BattleScript_ToxicOrbPoison
	end2
	
BattleScript_ToxicOrbPoison::
...
BattleScript_EffectHoneClaws::
	...
	attackstring
	ppreduce
	jumpifstat BS_TARGET, CMP_LESS_THAN, STAT_ATK, MAX_STAT_STAGE, BattleScript_HoneClawsDoMoveAnim
	jumpifstat BS_TARGET, CMP_EQUAL, STAT_ACC, MAX_STAT_STAGE, BattleScript_CantRaiseMultipleStats
BattleScript_HoneClawsDoMoveAnim::
	...
	setstatchanger STAT_ATK, 1, FALSE
	statbuffchange MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_ALLOW_PTR, BattleScript_HoneClawsTryDef
	jumpifbyte CMP_EQUAL, cMULTISTRING_CHOOSER, B_MSG_STAT_WONT_INCREASE, BattleScript_HoneClawsTryDef
	printfromtable gStatUpStringIds
	waitmessage B_WAIT_TIME_LONG
BattleScript_HoneClawsTryDef::
