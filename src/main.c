...
const u8 gGameVersionFireRed = GAME_VERSION_FIRERED;
const u8 gGameVersionLeafGreen = GAME_VERSION_LEAFGREEN;
const u8 gGameVersionRuby = GAME_VERSION_RUBY;
const u8 gGameVersionSapphire = GAME_VERSION_SAPPHIRE;
