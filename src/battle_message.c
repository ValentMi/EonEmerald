...
static const u8 sText_PkmnPreventsStatLossWith[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s stats cannot be lowered!");
...
static const u8 sText_PkmnsXRestoredHPALittle2[] = _("{B_ATK_NAME_WITH_PREFIX} restored\nits HP a little!");
...
static const u8 sText_PkmnsXCuredYProblem[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_BUFF1} problem\nfaded away!");
...
static const u8 sText_PkmnsXPreventsFlinching[] = _("{B_EFF_NAME_WITH_PREFIX} is not affected\nby flinching!");
...
static const u8 sText_StartedHail[] = _("It started to snow!");
static const u8 sText_HailContinues[] = _("Snow continues to fall.");
static const u8 sText_HailStopped[] = _("The snow stopped.");
...
static const u8 sText_PkmnsItemRestoredHPALittle[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} was hurt by\nits {B_LAST_ITEM}!");
static const u8 sText_ItemAllowsOnlyYMove[] = _("{B_LAST_ITEM} does not allow\nthis move to be selected.\p");
static const u8 sText_PkmnHungOnWithX[] = _("{B_DEF_NAME_WITH_PREFIX} endured the\nattack!");
