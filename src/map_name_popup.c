...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping[] =
{
    ...
    [MAPSEC_VERDANTURF_TOWN] = MAPPOPUP_THEME_STONE2,
    ...
    [MAPSEC_FORTREE_CITY] = MAPPOPUP_THEME_STONE2,
	...
	[MAPSEC_ROUTE_14] = MAPPOPUP_THEME_STONE,
	[MAPSEC_MONEAN_CHAMBER] = MAPSEC_MONEAN_CHAMBER,
    ...
    [MAPSEC_FARAWAY_ISLAND - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE2,
