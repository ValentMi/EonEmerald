...
//CONDITIONAL PSS
    ...
    if ((MOVE_HYPER_VOICE) && attacker->species == SPECIES_WIGGLYTUFF)
		gBattleMoves[move].category == MOVE_CATEGORY_SPECIAL;
    if ((MOVE_AIR_CUTTER) && attacker->species == SPECIES_NOCTOWL || attacker->species == SPECIES_YANMA || attacker->species == SPECIES_ARTICUNO || attacker->species == SPECIES_ZAPDOS || attacker->species == SPECIES_MOLTRES)
		gBattleMoves[move].category == MOVE_CATEGORY_SPECIAL;
