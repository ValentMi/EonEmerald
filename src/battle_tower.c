...
const u16 gBattleFrontierHeldItems[] =
{
    ...
    [BATTLE_FRONTIER_ITEM_MACHO_BRACE]    = ITEM_ELECTIRIZER,//ELECTIRIZER
    ...
    [BATTLE_FRONTIER_ITEM_SOUL_DEW]       = ITEM_EVERSTONE,//EVIOLITE
    ...
    [BATTLE_FRONTIER_ITEM_DRAGON_SCALE]   = ITEM_CHOICE_SPECS, // CHOICE SPECS
    ...
    [BATTLE_FRONTIER_ITEM_SEA_INCENSE]    = ITEM_LUCKY_EGG, //LUCKY EGG
    ...
    [BATTLE_FRONTIER_ITEM_APICOT_BERRY]   = ITEM_MAGMARIZER,//MAGMARIZER
    ...
    [BATTLE_FRONTIER_ITEM_LAX_INCENSE]    = ITEM_LIFE_ORB, // LIFE ORB
    ...
    [BATTLE_FRONTIER_ITEM_GANLON_BERRY]   = ITEM_CHOICE_SCARF,//CHOICE SCARF
};
...
const u8 gTowerMaleFacilityClasses[51] =
{
	...
	FACILITY_CLASS_BROCK,
	FACILITY_CLASS_SURGE,
	FACILITY_CLASS_KOGA,
	FACILITY_CLASS_BLAINE,
	FACILITY_CLASS_GIOVANNI,
	FACILITY_CLASS_BRUNO,
	FACILITY_CLASS_LANCE,
	FACILITY_CLASS_BLUE,
	FACILITY_CLASS_WATTSON,
	FACILITY_CLASS_NORMAN,
	FACILITY_CLASS_TATE,
	FACILITY_CLASS_JUAN,
...
const u8 gTowerFemaleFacilityClasses[32] =
{
	...
	FACILITY_CLASS_LASS,
	FACILITY_CLASS_MISTY,
	FACILITY_CLASS_ERIKA,
	...
	FACILITY_CLASS_FLANNERY,
	FACILITY_CLASS_WINONA,
	FACILITY_CLASS_LIZA,
	FACILITY_CLASS_GLACIA,
	FACILITY_CLASS_LEAF,
};

const u8 gTowerMaleTrainerGfxIds[51] =
{
	OBJ_EVENT_GFX_HIKER,
...
const u8 gTowerFemaleTrainerGfxIds[32] =
{
...
{
    {FRONTIER_TRAINER_BRADY,   FRONTIER_TRAINER_JILL},   //   0 -  99 RIVALS + GYM 1 & 2
    {FRONTIER_TRAINER_TREVIN,  FRONTIER_TRAINER_CHLOE},  //  80 - 119 GYM 3 & 4
    {FRONTIER_TRAINER_ERIK,    FRONTIER_TRAINER_SOFIA},  // 100 - 139 GYM 5 & 6
    {FRONTIER_TRAINER_NORTON,  FRONTIER_TRAINER_JAZLYN}, // 120 - 159 GYM 7 & 8
    {FRONTIER_TRAINER_BRADEN,  FRONTIER_TRAINER_ALISON}, // 140 - 179 ELITE4 1 & 2
    {FRONTIER_TRAINER_ZACHERY, FRONTIER_TRAINER_LAMAR},  // 160 - 199 ELITE4 3 & 4
    {FRONTIER_TRAINER_HANK,    FRONTIER_TRAINER_TESS},   // 180 - 219 CHAMPIONS
    {FRONTIER_TRAINER_JAXON,   FRONTIER_TRAINER_GRETEL}, // 200 - 299 ALL
};
