...
{
    {ITEM_HYPER_POTION, ITEM_FLUFFY_TAIL, ITEM_LUM_BERRY, ITEM_LEPPA_BERRY, ITEM_LUM_BERRY, ITEM_REVIVE, ITEM_BRIGHT_POWDER, ITEM_SHELL_BELL, ITEM_MAX_REVIVE, ITEM_SACRED_ASH},
    {ITEM_HYPER_POTION, ITEM_MAX_REVIVE, ITEM_LUM_BERRY, ITEM_LEPPA_BERRY, ITEM_CHOICE_SCARF, ITEM_REVIVE, ITEM_LEFTOVERS, ITEM_CHOICE_BAND, ITEM_FULL_RESTORE, ITEM_MAX_ELIXIR},
    {ITEM_MAX_POTION, ITEM_X_ATTACK, ITEM_LUM_BERRY, ITEM_LEPPA_BERRY, ITEM_LUM_BERRY, ITEM_REVIVE, ITEM_SCOPE_LENS, ITEM_FOCUS_BAND, ITEM_MAX_REVIVE, ITEM_SACRED_ASH},
    {ITEM_HYPER_POTION, ITEM_X_DEFEND, ITEM_LUM_BERRY, ITEM_LEPPA_BERRY, ITEM_CHOICE_SPECS, ITEM_REVIVE, ITEM_QUICK_CLAW, ITEM_KINGS_ROCK, ITEM_FULL_RESTORE, ITEM_MAX_ELIXIR},
    {ITEM_MAX_POTION, ITEM_X_SPEED, ITEM_CHESTO_BERRY, ITEM_LEPPA_BERRY, ITEM_LUM_BERRY, ITEM_REVIVE, ITEM_BRIGHT_POWDER, ITEM_SHELL_BELL, ITEM_MAX_REVIVE, ITEM_SACRED_ASH},
    {ITEM_HYPER_POTION, ITEM_MAX_REVIVE, ITEM_LUM_BERRY, ITEM_LEPPA_BERRY, ITEM_CHOICE_SCARF, ITEM_REVIVE, ITEM_LEFTOVERS, ITEM_CHOICE_BAND, ITEM_FULL_RESTORE, ITEM_MAX_ELIXIR},
    {ITEM_MAX_POTION, ITEM_X_SPECIAL, ITEM_LUM_BERRY, ITEM_LEPPA_BERRY, ITEM_MAX_REVIVE, ITEM_REVIVE, ITEM_SCOPE_LENS, ITEM_FOCUS_BAND, ITEM_MAX_REVIVE, ITEM_SACRED_ASH},
    {ITEM_HYPER_POTION, ITEM_GUARD_SPEC, ITEM_LUM_BERRY, ITEM_LEPPA_BERRY, ITEM_CHOICE_SPECS, ITEM_REVIVE, ITEM_QUICK_CLAW, ITEM_KINGS_ROCK, ITEM_FULL_RESTORE, ITEM_MAX_ELIXIR},
    {ITEM_MAX_POTION, ITEM_FLUFFY_TAIL, ITEM_LUM_BERRY, ITEM_LEPPA_BERRY, ITEM_LUM_BERRY, ITEM_REVIVE, ITEM_BRIGHT_POWDER, ITEM_SHELL_BELL, ITEM_MAX_REVIVE, ITEM_SACRED_ASH},
    {ITEM_HYPER_POTION, ITEM_MAX_REVIVE, ITEM_LUM_BERRY, ITEM_LEPPA_BERRY, ITEM_ASSAULT_VEST, ITEM_REVIVE, ITEM_LEFTOVERS, ITEM_CHOICE_BAND, ITEM_FULL_RESTORE, ITEM_MAX_ELIXIR},
    {ITEM_MAX_POTION, ITEM_X_ATTACK, ITEM_LUM_BERRY, ITEM_LEPPA_BERRY, ITEM_MAX_REVIVE, ITEM_REVIVE, ITEM_SCOPE_LENS, ITEM_FOCUS_BAND, ITEM_MAX_REVIVE, ITEM_SACRED_ASH},
    {ITEM_HYPER_POTION, ITEM_X_DEFEND, ITEM_LUM_BERRY, ITEM_LEPPA_BERRY, ITEM_ASSAULT_VEST, ITEM_REVIVE, ITEM_QUICK_CLAW, ITEM_KINGS_ROCK, ITEM_FULL_RESTORE, ITEM_MAX_ELIXIR},
    {ITEM_MAX_POTION, ITEM_X_SPEED, ITEM_LUM_BERRY, ITEM_LEPPA_BERRY, ITEM_LUM_BERRY, ITEM_REVIVE, ITEM_BRIGHT_POWDER, ITEM_SHELL_BELL, ITEM_MAX_REVIVE, ITEM_SACRED_ASH},
    {ITEM_HYPER_POTION, ITEM_MAX_REVIVE, ITEM_LUM_BERRY, ITEM_LEPPA_BERRY, ITEM_LIFE_ORB, ITEM_REVIVE, ITEM_LEFTOVERS, ITEM_CHOICE_BAND, ITEM_FULL_RESTORE, ITEM_MAX_ELIXIR},
    {ITEM_MAX_POTION, ITEM_X_SPECIAL, ITEM_LUM_BERRY, ITEM_LEPPA_BERRY, ITEM_MAX_REVIVE, ITEM_REVIVE, ITEM_SCOPE_LENS, ITEM_FOCUS_BAND, ITEM_MAX_REVIVE, ITEM_SACRED_ASH},
    {ITEM_HYPER_POTION, ITEM_MAX_REVIVE, ITEM_LUM_BERRY, ITEM_LEPPA_BERRY, ITEM_LIFE_ORB, ITEM_REVIVE, ITEM_QUICK_CLAW, ITEM_KINGS_ROCK, ITEM_FULL_RESTORE, ITEM_MAX_ELIXIR},
    {ITEM_MAX_POTION, ITEM_FLUFFY_TAIL, ITEM_LUM_BERRY, ITEM_LEPPA_BERRY, ITEM_LUM_BERRY, ITEM_REVIVE, ITEM_BRIGHT_POWDER, ITEM_SHELL_BELL, ITEM_MAX_REVIVE, ITEM_SACRED_ASH},
    {ITEM_HYPER_POTION, ITEM_MAX_REVIVE, ITEM_LUM_BERRY, ITEM_LEPPA_BERRY, ITEM_LIFE_ORB, ITEM_REVIVE, ITEM_LEFTOVERS, ITEM_CHOICE_BAND, ITEM_FULL_RESTORE, ITEM_MAX_ELIXIR},
    {ITEM_MAX_POTION, ITEM_X_ATTACK, ITEM_LUM_BERRY, ITEM_LEPPA_BERRY, ITEM_LUM_BERRY, ITEM_REVIVE, ITEM_SCOPE_LENS, ITEM_FOCUS_BAND, ITEM_MAX_REVIVE, ITEM_SACRED_ASH},
    {ITEM_HYPER_POTION, ITEM_X_DEFEND, ITEM_LUM_BERRY, ITEM_LEPPA_BERRY, ITEM_LIFE_ORB, ITEM_REVIVE, ITEM_QUICK_CLAW, ITEM_KINGS_ROCK, ITEM_FULL_RESTORE, ITEM_MAX_ELIXIR},
};
