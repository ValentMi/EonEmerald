...
const struct MonCoords gMonFrontPicCoords[] =
{
    ...
    [SPECIES_CATERPIE]    = { .size = MON_COORDS_SIZE(32, 40), .y_offset = 13 },
    [SPECIES_METAPOD]     = { .size = MON_COORDS_SIZE(40, 32), .y_offset = 17 },
    [SPECIES_BUTTERFREE]  = { .size = MON_COORDS_SIZE(56, 48), .y_offset =  9 },
    [SPECIES_WEEDLE]      = { .size = MON_COORDS_SIZE(40, 32), .y_offset = 14 },
    ...
    [SPECIES_RATICATE]    = { .size = MON_COORDS_SIZE(48, 48), .y_offset = 8 },
    ...
    [SPECIES_POLIWAG]     = { .size = MON_COORDS_SIZE(56, 32), .y_offset = 15 },
    ...
    [SPECIES_LAPRAS]      = { .size = MON_COORDS_SIZE(64, 40), .y_offset = 4 },
    ...
    [SPECIES_DRATINI]     = { .size = MON_COORDS_SIZE(56, 40), .y_offset = 10 },
    ...
    [SPECIES_LEDYBA]      = { .size = MON_COORDS_SIZE(40, 48), .y_offset = 10 },
    [SPECIES_LEDIAN]      = { .size = MON_COORDS_SIZE(48, 56), .y_offset =  4 },
    [SPECIES_SPINARAK]    = { .size = MON_COORDS_SIZE(40, 32), .y_offset = 17 },
    ...
    [SPECIES_LINOONE]     = { .size = MON_COORDS_SIZE(56, 64), .y_offset =  6 },
    ...
    [SPECIES_LUVDISC]     = { .size = MON_COORDS_SIZE(32, 48), .y_offset = 13 },
    ...
    [SPECIES_SWABLU]      = { .size = MON_COORDS_SIZE(56, 48), .y_offset = 13 },
    ...
    [SPECIES_BANETTE]     = { .size = MON_COORDS_SIZE(40, 40), .y_offset =  6 },
    ...
    [SPECIES_ARON]        = { .size = MON_COORDS_SIZE(32, 24), .y_offset = 16 },
    [SPECIES_LAIRON]      = { .size = MON_COORDS_SIZE(56, 40), .y_offset = 11 },
