const u8 gFacilityClassToPicIndex[] =
{
	...
	[FACILITY_CLASS_BROCK] = TRAINER_PIC_BROCK,
	[FACILITY_CLASS_SURGE] = TRAINER_PIC_SURGE,
	[FACILITY_CLASS_KOGA] = TRAINER_PIC_KOGA,
	[FACILITY_CLASS_BLAINE] = TRAINER_PIC_BLAINE,
	[FACILITY_CLASS_GIOVANNI] = TRAINER_PIC_GIOVANNI,
	[FACILITY_CLASS_BRUNO] = TRAINER_PIC_BRUNO,
	[FACILITY_CLASS_LANCE] = TRAINER_PIC_LANCE,
	[FACILITY_CLASS_BLUE] = TRAINER_PIC_BLUE,
	[FACILITY_CLASS_WATTSON] = TRAINER_PIC_LEADER_WATTSON,
	[FACILITY_CLASS_NORMAN] = TRAINER_PIC_LEADER_NORMAN,
	[FACILITY_CLASS_TATE] = TRAINER_PIC_TATE,
	[FACILITY_CLASS_JUAN] = TRAINER_PIC_LEADER_JUAN,
	[FACILITY_CLASS_DRAKE] = TRAINER_PIC_ELITE_FOUR_DRAKE,
	[FACILITY_CLASS_MISTY] = TRAINER_PIC_MISTY,
	[FACILITY_CLASS_ERIKA] = TRAINER_PIC_ERIKA,
	[FACILITY_CLASS_SABRINA] = TRAINER_PIC_SABRINA,
	[FACILITY_CLASS_LORELEI] = TRAINER_PIC_LORELEI,
	[FACILITY_CLASS_AGATHA] = TRAINER_PIC_AGATHA,
	[FACILITY_CLASS_FLANNERY] = TRAINER_PIC_LEADER_FLANNERY,
	[FACILITY_CLASS_WINONA] = TRAINER_PIC_LEADER_WINONA,
	[FACILITY_CLASS_LIZA] = TRAINER_PIC_LIZA,
...
const u8 gFacilityClassToTrainerClass[] =
{
    ...
    [FACILITY_CLASS_RED] = TRAINER_CLASS_PKMN_TRAINER_2,
    [FACILITY_CLASS_LEAF] = TRAINER_CLASS_PKMN_TRAINER_2,
    [FACILITY_CLASS_RS_BRENDAN] = TRAINER_CLASS_RS_PROTAG,
    [FACILITY_CLASS_RS_MAY] = TRAINER_CLASS_RS_PROTAG,
	[FACILITY_CLASS_BROCK] = TRAINER_CLASS_LEADER_2,
	[FACILITY_CLASS_SURGE] = TRAINER_CLASS_LEADER_2,
	[FACILITY_CLASS_KOGA] = TRAINER_CLASS_LEADER_2,
	[FACILITY_CLASS_BLAINE] = TRAINER_CLASS_LEADER_2,
	[FACILITY_CLASS_GIOVANNI] = TRAINER_CLASS_LEADER_2,
	[FACILITY_CLASS_BRUNO] = TRAINER_CLASS_ELITE_FOUR,
	[FACILITY_CLASS_LANCE] = TRAINER_CLASS_ELITE_FOUR,
	[FACILITY_CLASS_BLUE] = TRAINER_CLASS_PKMN_TRAINER_2,
	[FACILITY_CLASS_WATTSON] = TRAINER_CLASS_LEADER,
	[FACILITY_CLASS_NORMAN] = TRAINER_CLASS_LEADER,
	[FACILITY_CLASS_TATE] = TRAINER_CLASS_LEADER,
	[FACILITY_CLASS_JUAN] = TRAINER_CLASS_LEADER,
	[FACILITY_CLASS_DRAKE] = TRAINER_CLASS_ELITE_FOUR,
	[FACILITY_CLASS_MISTY] = TRAINER_CLASS_LEADER_2,
	[FACILITY_CLASS_ERIKA] = TRAINER_CLASS_LEADER_2,
	[FACILITY_CLASS_SABRINA] = TRAINER_CLASS_LEADER_2,
	[FACILITY_CLASS_LORELEI] = TRAINER_CLASS_ELITE_FOUR,
	[FACILITY_CLASS_AGATHA] = TRAINER_CLASS_ELITE_FOUR,
	[FACILITY_CLASS_FLANNERY] = TRAINER_CLASS_LEADER,
	[FACILITY_CLASS_WINONA] = TRAINER_CLASS_LEADER,
	[FACILITY_CLASS_LIZA] = TRAINER_CLASS_LEADER,
