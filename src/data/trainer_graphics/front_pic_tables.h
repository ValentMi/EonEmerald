...
const struct CompressedSpriteSheet gTrainerFrontPicTable[] =
{
	...
	TRAINER_SPRITE(SURGE, gTrainerFrontPic_Surge, TRAINER_PIC_SIZE),
	...
	TRAINER_SPRITE(TATE, gTrainerFrontPic_Tate, TRAINER_PIC_SIZE),
	TRAINER_SPRITE(LIZA, gTrainerFrontPic_Liza, TRAINER_PIC_SIZE),
};
...
const struct CompressedSpritePalette gTrainerFrontPicPaletteTable[] =
{
	...
	TRAINER_PAL(TATE, gTrainerPalette_LeaderTateAndLiza),
	TRAINER_PAL(LIZA, gTrainerPalette_LeaderTateAndLiza),
};
