...
static const struct TrainerMonNoItemCustomMoves sParty_Dusty1[] = {
    ...
    .moves = {MOVE_EARTHQUAKE, MOVE_SLASH, MOVE_RAPID_SPIN, MOVE_GUILLOTINE}
    },
    {
    .iv = 60,
    .lvl = 68,
    .species = SPECIES_MAROWAK,
    .moves = {MOVE_BONEMERANG, MOVE_ROCK_SLIDE, MOVE_SHADOW_PUNCH, MOVE_ASTONISH}
    },
    {
    .iv = 60,
    .lvl = 68,
    .species = SPECIES_FLYGON,
    .moves = {MOVE_EARTHQUAKE, MOVE_DRAGON_CLAW, MOVE_DRAGON_DANCE, MOVE_ROCK_SLIDE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Foster[] = {
    ...
    .moves = {MOVE_EARTHQUAKE, MOVE_SLASH, MOVE_SAND_ATTACK, MOVE_ROCK_SLIDE}
    },
    {
    .iv = 100,
    .lvl = 65,
    .species = SPECIES_CLAYDOL,
    .moves = {MOVE_PROTECT, MOVE_PSYBEAM, MOVE_SELF_DESTRUCT, MOVE_TOXIC}
    }
};
//Michael
static const struct TrainerMonItemCustomMoves sParty_Dusty2[] = {
    {.iv = 255, .lvl = 100, .species = SPECIES_VENUSAUR, .heldItem = ITEM_LEFTOVERS, .ability = 1, .moves = {MOVE_SLEEP_POWDER, MOVE_ACID, MOVE_SOLAR_BEAM, MOVE_SYNTHESIS}},
    {.iv = 255, .lvl = 100, .species = SPECIES_NINETALES, .heldItem = ITEM_WHITE_HERB, .ability = 1, .moves = {MOVE_OVERHEAT, MOVE_WILL_O_WISP, MOVE_ROAR, MOVE_SPITE}},
    {.iv = 255, .lvl = 100, .species = SPECIES_UMBREON, .heldItem = ITEM_LEFTOVERS, .ability = 0, .moves = {MOVE_WISH, MOVE_PROTECT, MOVE_TOXIC, MOVE_BATON_PASS}},
    {.iv = 255, .lvl = 100, .species = SPECIES_ESPEON, .heldItem = ITEM_FOCUS_BAND, .ability = 1, .moves = {MOVE_PSYCHIC, MOVE_CALM_MIND, MOVE_BATON_PASS, MOVE_SUBSTITUTE}},
    {.iv = 255, .lvl = 100, .species = SPECIES_POLIWRATH, .heldItem = ITEM_LEFTOVERS, .ability = 1, .moves = {MOVE_DIVE, MOVE_BULK_UP, MOVE_MEGA_PUNCH, MOVE_ICY_WIND}},
    {.iv = 255, .lvl = 100, .species = SPECIES_FLYGON, .heldItem = ITEM_CHOICE_SCARF, .ability = 0, .moves = {MOVE_FISSURE, MOVE_ROCK_SLIDE, MOVE_FIRE_BLAST, MOVE_GIGA_DRAIN}}
};
//DJ
static const struct TrainerMonItemCustomMoves sParty_Dusty3[] = {
{.iv = 255, .lvl = 100, .species = SPECIES_GYARADOS, .heldItem = ITEM_CELL_BATTERY, .ability = 0, .moves = {MOVE_DRAGON_DANCE, MOVE_ROCK_SLIDE, MOVE_DIVE, MOVE_TAUNT}},
    {.iv = 255, .lvl = 100, .species = SPECIES_AMPHAROS, .heldItem = ITEM_FOCUS_BAND, .ability = 0, .moves = {MOVE_THUNDERBOLT, MOVE_FIRE_PUNCH, MOVE_THUNDER_WAVE, MOVE_SUBSTITUTE}},
    {.iv = 255, .lvl = 100, .species = SPECIES_CHARIZARD, .heldItem = ITEM_LUM_BERRY, .ability = 0, .moves = {MOVE_FIRE_BLAST, MOVE_SOLAR_BEAM, MOVE_ROCK_SLIDE, MOVE_AIR_CUTTER}},
    {.iv = 255, .lvl = 100, .species = SPECIES_LUDICOLO, .heldItem = ITEM_LEFTOVERS, .ability = 0, .moves = {MOVE_SURF, MOVE_GIGA_DRAIN, MOVE_ICY_WIND, MOVE_RAIN_DANCE}},
    {.iv = 255, .lvl = 100, .species = SPECIES_PIDGEOT, .heldItem = ITEM_CHOICE_BAND, .ability = 0, .moves = {MOVE_DOUBLE_EDGE, MOVE_AERIAL_ACE, MOVE_STEEL_WING, MOVE_QUICK_ATTACK}},
    {.iv = 255, .lvl = 100, .species = SPECIES_GARDEVOIR, .heldItem = ITEM_CHOICE_SCARF, .ability = 1, .moves = {MOVE_PSYCHIC, MOVE_THUNDERBOLT, MOVE_SHADOW_BALL, MOVE_ICE_BEAM}}
};
//JL
static const struct TrainerMonItemCustomMoves sParty_Dusty4[] = {

    {.iv = 255, .lvl = 100, .species = SPECIES_SWAMPERT, .heldItem = ITEM_LEFTOVERS, .ability = 0, .moves = {MOVE_SURF, MOVE_FISSURE, MOVE_ICE_BEAM, MOVE_PROTECT}},
    {.iv = 255, .lvl = 100, .species = SPECIES_TYRANITAR, .heldItem = ITEM_LUM_BERRY, .ability = 0, .moves = {MOVE_DRAGON_DANCE, MOVE_ROCK_SLIDE, MOVE_THUNDER_WAVE, MOVE_PURSUIT}},
    {.iv = 255, .lvl = 100, .species = SPECIES_SHUCKLE, .heldItem = ITEM_LEFTOVERS, .ability = 0, .moves = {MOVE_TOXIC, MOVE_WRAP, MOVE_REST, MOVE_ENCORE}},
    {.iv = 255, .lvl = 100, .species = SPECIES_GLIGAR, .heldItem = ITEM_TOXIC_ORB, .ability = 0, .moves = {MOVE_FEATHER_DANCE, MOVE_DIG, MOVE_TOXIC, MOVE_ROCK_SLIDE}},
    {.iv = 255, .lvl = 100, .species = SPECIES_GLALIE, .heldItem = ITEM_FOCUS_BAND, .ability = 1, .moves = {MOVE_SPIKES, MOVE_ICY_WIND, MOVE_BLIZZARD, MOVE_POWDER_SNOW}},
    {.iv = 255, .lvl = 100, .species = SPECIES_SALAMENCE, .heldItem = ITEM_CHOICE_BAND, .ability = 0, .moves = {MOVE_FIRE_BLAST, MOVE_ROCK_SLIDE, MOVE_HYDRO_PUMP, MOVE_AERIAL_ACE}}
};
//Jessica
...
static const struct TrainerMonNoItemCustomMoves sParty_Wendy[] = {
    ...
    .lvl = 59,
    .species = SPECIES_MAWILE,
    .moves = {MOVE_BATON_PASS, MOVE_PURSUIT, MOVE_SWORDS_DANCE, MOVE_GUILLOTINE}
    },
    {
    .iv = 100,
    .lvl = 59,
    .species = SPECIES_SUNFLORA,
    .moves = {MOVE_GIGA_DRAIN, MOVE_SOLAR_BEAM, MOVE_HEAT_WAVE, MOVE_LEECH_SEED}
    },
    {
    .iv = 100,
    .lvl = 59,
    .species = SPECIES_OCTILLERY,
    .moves = {MOVE_FLAMETHROWER, MOVE_OCTAZOOKA, MOVE_BULLET_SEED, MOVE_ICE_BEAM}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Cindy6[] = {
    ...
    .heldItem = ITEM_NUGGET,
	.ability = 0,
    .moves = {MOVE_BELLY_DRUM, MOVE_EXTREME_SPEED, MOVE_DIG, MOVE_SUBSTITUTE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Beau[] = {
    ...
    .moves = {MOVE_POISON_TAIL, MOVE_FIRE_BLAST, MOVE_EARTHQUAKE, MOVE_ROCK_SLIDE}
    },
    {
    .iv = 0,
    .lvl = 66,
    .species = SPECIES_DONPHAN,
    .moves = {MOVE_RAPID_SPIN, MOVE_ROCK_SLIDE, MOVE_EARTHQUAKE, MOVE_FRUSTRATION}
    },
    {
    .iv = 0,
    .lvl = 66,
    .species = SPECIES_STEELIX,
    .moves = {MOVE_DRAGON_DANCE, MOVE_IRON_TAIL, MOVE_EARTHQUAKE, MOVE_ROCK_TOMB}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Sidney[] = {
	...
	.ability = 0,
    .moves = {MOVE_HOWL, MOVE_DOUBLE_EDGE, MOVE_ROAR, MOVE_CRUNCH}
    },
    {
    .iv = 255,
    .lvl = 49,
	...
	.ability = 0,
    .moves = {MOVE_SUNNY_DAY, MOVE_HEAT_WAVE, MOVE_SOLAR_BEAM, MOVE_EXPLOSION}
    },
    {
    .iv = 255,
    .lvl = 49,
	.evs = {155, 255, 100, 0, 0, 0},
    .species = SPECIES_CACTURNE,
    .heldItem = ITEM_LEFTOVERS,
	.ability = 0,
    .moves = {MOVE_SPIKES, MOVE_DESTINY_BOND, MOVE_NEEDLE_ARM, MOVE_SWORDS_DANCE}
    },
    {
    .iv = 255,
    .lvl = 50,
	...
	.ability = 0,
    .moves = {MOVE_CRABHAMMER, MOVE_SWORDS_DANCE, MOVE_BRICK_BREAK, MOVE_DIVE}
    },
    {
    .iv = 255,
    .lvl = 50,
    ...
    .heldItem = ITEM_LEFTOVERS,
	.ability = 0,
    .moves = {MOVE_TOXIC, MOVE_PROTECT, MOVE_WISH, MOVE_CRUNCH}
    },
    {
    .iv = 255,
    .lvl = 52,
...
static const struct TrainerMonItemCustomMoves sParty_Phoebe[] = {
	...
	.ability = 0,
    .moves = {MOVE_SHADOW_BALL, MOVE_THUNDER_WAVE, MOVE_CURSE, MOVE_DESTINY_BOND}
    },
    {
    .iv = 255,
    .lvl = 51,
	...
	.ability = 0,
    .moves = {MOVE_PSYCHIC, MOVE_CALM_MIND, MOVE_WILL_O_WISP, MOVE_FIRE_BLAST}
    },
    {
    .iv = 255,
    .lvl = 52,
    ...
    .heldItem = ITEM_LEFTOVERS,
	.ability = 0,
    .moves = {MOVE_TOXIC, MOVE_RECOVER, MOVE_NIGHT_SHADE, MOVE_KNOCK_OFF}
    },
    {
    .iv = 255,
    .lvl = 52,
    ...
    .heldItem = ITEM_FOCUS_BAND,
	.ability = 0,
    .moves = {MOVE_TOXIC, MOVE_SHADOW_BALL, MOVE_THUNDERBOLT, MOVE_ICE_PUNCH}
    },
    {
    .iv = 255,
    .lvl = 52,
    ...
    .heldItem = ITEM_LUM_BERRY,
	.ability = 0,
    .moves = {MOVE_SHADOW_BALL, MOVE_FURY_CUTTER, MOVE_SWORDS_DANCE, MOVE_PROTECT}
    },
    {
    .iv = 255,
    .lvl = 53,
	.evs = {252, 36, 20, 0, 200, 0},
    .species = SPECIES_DUSCLOPS,
    .heldItem = ITEM_EVERSTONE,
	.ability = 0,
    .moves = {MOVE_SHADOW_BALL, MOVE_SEISMIC_TOSS, MOVE_WILL_O_WISP, MOVE_PAIN_SPLIT}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Glacia[] = {
    ...
    .heldItem = ITEM_LEFTOVERS,
	.ability = 0,
    .moves = {MOVE_SPIKES, MOVE_TAUNT, MOVE_BLIZZARD, MOVE_EXPLOSION}
    },
    {
    .iv = 255,
    .lvl = 52,
    ...
    .heldItem = ITEM_EVERSTONE,
	.ability = 0,
    .moves = {MOVE_SWORDS_DANCE, MOVE_KNOCK_OFF, MOVE_ICE_PUNCH, MOVE_LOW_KICK}
    },
    {
    .iv = 255,
    .lvl = 53,
    ...
    .heldItem = ITEM_LIFE_ORB,
	.ability = 0,
    .moves = {MOVE_LOVELY_KISS, MOVE_PSYCHIC, MOVE_ICE_BEAM, MOVE_SUBSTITUTE}
    },
    {
    .iv = 255,
    .lvl = 53,
    ...
    .heldItem = ITEM_LIFE_ORB,
	.ability = 0,
    .moves = {MOVE_SPIKES, MOVE_WATERFALL, MOVE_RAPID_SPIN, MOVE_ICICLE_SPEAR}
    },
    {
    .iv = 255,
    .lvl = 54,
	.evs = {92, 0, 16, 128, 32, 240},
    .species = SPECIES_CASTFORM,
    .heldItem = ITEM_LEFTOVERS,
	.ability = 0,
    .moves = {MOVE_BLIZZARD, MOVE_THUNDERBOLT, MOVE_HAIL, MOVE_THUNDER_WAVE}
    },
    {
    .iv = 255,
    .lvl = 55,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
	.ability = 0,
    .moves = {MOVE_DIVE, MOVE_SWORDS_DANCE, MOVE_EARTHQUAKE, MOVE_ICICLE_SPEAR}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Drake[] = {
    ...
    .iv = 255,
    .lvl = 54,
	.evs = {160, 252, 0, 84, 12, 0},
    .species = SPECIES_AGGRON,
    .heldItem = ITEM_LEFTOVERS,
	.ability = 0,
    .moves = {MOVE_ROCK_SLIDE, MOVE_EARTHQUAKE, MOVE_SUBSTITUTE, MOVE_THUNDER_WAVE}
    },
    {
    .iv = 255,
    .lvl = 56,
	.evs = {248, 0, 44, 0, 216, 0},
    .species = SPECIES_ALTARIA,
    .heldItem = ITEM_LEFTOVERS,
	.ability = 0,
    .moves = {MOVE_TOXIC, MOVE_FIRE_BLAST, MOVE_PERISH_SONG, MOVE_REST}
    },
    {
    .iv = 255,
    .lvl = 56,
	.evs = {248, 0, 44, 216, 0, 0},
    .species = SPECIES_SCEPTILE,
    .heldItem = ITEM_LEFTOVERS,
	.ability = 0,
    .moves = {MOVE_SUBSTITUTE, MOVE_LEECH_SEED, MOVE_LEAF_BLADE, MOVE_DRAGON_BREATH}
    },
    {
    .iv = 255,
    .lvl = 56,
    ...
    .heldItem = ITEM_LIFE_ORB,
	.ability = 0,
    .moves = {MOVE_RAIN_DANCE, MOVE_DRAGON_BREATH, MOVE_SURF, MOVE_ICE_BEAM}
    },
    {
    .iv = 255,
    .lvl = 56,
    ...
    .heldItem = ITEM_LUM_BERRY,
	.ability = 0,
    .moves = {MOVE_EARTHQUAKE, MOVE_ROCK_SLIDE, MOVE_DRAGON_DANCE, MOVE_FURY_CUTTER}
    },
    {
    .iv = 255,
    .lvl = 58,
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne1[] = {
	...
	.ability = 1,
    .moves = {MOVE_ACID, MOVE_CONFUSE_RAY, MOVE_ABSORB, MOVE_ROCK_TOMB}
    },
    {
    .iv = 100,
    .lvl = 12,
	...
	.ability = 1,
    .moves = {MOVE_METAL_CLAW, MOVE_DIG, MOVE_HEADBUTT, MOVE_ROCK_TOMB}
    },
    {
    .iv = 100,
    .lvl = 12,
    ...
    .heldItem = ITEM_CHERI_BERRY,
	.ability = 1,
    .moves = {MOVE_METAL_CLAW, MOVE_FURY_CUTTER, MOVE_WATER_GUN, MOVE_ROCK_TOMB}
    },
    {
    .iv = 200,
    .lvl = 15,
    ...
    .heldItem = ITEM_ORAN_BERRY,
	.ability = 0,
    .moves = {MOVE_THUNDER_SHOCK, MOVE_THUNDER_WAVE, MOVE_SANDSTORM, MOVE_ROCK_TOMB}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Brawly1[] = {
    ...
    .heldItem = ITEM_CHOICE_SCARF,
	.ability = 0,
    .moves = {MOVE_KARATE_CHOP, MOVE_KNOCK_OFF, MOVE_ROCK_TOMB, MOVE_DIG}
    },
    {
    .iv = 100,
    .lvl = 18,
	...
	.ability = 0,
    .moves = {MOVE_BRICK_BREAK, MOVE_HORN_ATTACK, MOVE_HEADBUTT, MOVE_BULK_UP}
    },
    {
    .iv = 200,
    .lvl = 19,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
	.ability = 0,
    .moves = {MOVE_ARM_THRUST, MOVE_WHIRLWIND, MOVE_KNOCK_OFF, MOVE_BULK_UP}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Wattson1[] = {
    ...
    .heldItem = ITEM_FOCUS_BAND,
	.ability = 0,
    .moves = {MOVE_LIGHT_SCREEN, MOVE_REFLECT, MOVE_SELF_DESTRUCT, MOVE_SHOCK_WAVE}
    },
    {
    .iv = 200,
    .lvl = 21,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
	.ability = 0,
    .moves = {MOVE_SHOCK_WAVE, MOVE_SURF, MOVE_QUICK_ATTACK, MOVE_BRICK_BREAK}
    },
    {
    .iv = 220,
    .lvl = 23,
	...
	.ability = 1,
    .moves = {MOVE_REFLECT, MOVE_SHOCK_WAVE, MOVE_THUNDER_WAVE, MOVE_METAL_SOUND}
    },
    {
    .iv = 255,
    .lvl = 24,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
	.ability = 0,
    .moves = {MOVE_CRUNCH, MOVE_THUNDER_WAVE, MOVE_THUNDER, MOVE_HOWL}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Flannery1[] = {
    ...
    .heldItem = ITEM_SITRUS_BERRY,
	.ability = 1,
    .moves = {MOVE_OVERHEAT, MOVE_GRUDGE, MOVE_SOLAR_BEAM, MOVE_SUNNY_DAY}
    },
    {
    .iv = 200,
    .lvl = 24,
	...
	.ability = 0,
    .moves = {MOVE_OVERHEAT, MOVE_RECOVER, MOVE_TOXIC, MOVE_SUNNY_DAY}
    },
    {
    .iv = 255,
    .lvl = 26,
	...
	.ability = 0,
    .moves = {MOVE_OVERHEAT, MOVE_MAGNITUDE, MOVE_CURSE, MOVE_ROCK_TOMB}
    },
    {
    .iv = 255,
    .lvl = 29,
    ...
    .heldItem = ITEM_WHITE_HERB,
	.ability = 0,
    .moves = {MOVE_OVERHEAT, MOVE_TOXIC, MOVE_REST, MOVE_AMNESIA}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Norman1[] = {
	...
	.ability = 0,
    .moves = {MOVE_TEETER_DANCE, MOVE_HYPNOSIS, MOVE_FACADE, MOVE_ENCORE}
    },
    {
    .iv = 200,
    .lvl = 27,
    ...
    .heldItem = ITEM_LIFE_ORB,
	.ability = 0,
    .moves = {MOVE_PSYCHIC, MOVE_FACADE, MOVE_THUNDERBOLT, MOVE_SOLAR_BEAM}
    },
    {
    .iv = 200,
    .lvl = 29,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
	.ability = 0,
    .moves = {MOVE_TICKLE, MOVE_BELLY_DRUM, MOVE_FACADE, MOVE_EXTREME_SPEED}
    },
    {
    .iv = 255,
    .lvl = 31,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
	.ability = 0,
    .moves = {MOVE_COUNTER, MOVE_BRICK_BREAK, MOVE_FACADE, MOVE_FAINT_ATTACK}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Winona1[] = {
    ...
    .heldItem = ITEM_LEFTOVERS,
	.ability = 1,
    .moves = {MOVE_STEEL_WING, MOVE_SPIKES, MOVE_ROAR, MOVE_TOXIC}
    },
    {
    .iv = 210,
    .lvl = 33,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
	.ability = 0,
    .moves = {MOVE_SOLAR_BEAM, MOVE_AERIAL_ACE, MOVE_EARTHQUAKE, MOVE_DRAGON_DANCE}
    },
    {
    .iv = 210,
    .lvl = 34,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
	.ability = 0,
    .moves = {MOVE_SLUDGE_BOMB, MOVE_SHADOW_BALL, MOVE_WHIRLWIND, MOVE_AERIAL_ACE}
    },
    {
    .iv = 255,
    .lvl = 36,
...
static const struct TrainerMonItemCustomMoves sParty_TateAndLiza1[] = {
    ...
    .heldItem = ITEM_SITRUS_BERRY,
	.ability = 0,
    .moves = {MOVE_PROTECT, MOVE_ANCIENT_POWER, MOVE_PSYCHIC, MOVE_TOXIC}
    },
    {
    .iv = 255,
    .lvl = 41,
    ...
    .heldItem = ITEM_LIFE_ORB,
	.ability = 0,
    .moves = {MOVE_PSYCHIC, MOVE_LIGHT_SCREEN, MOVE_SHADOW_BALL, MOVE_CALM_MIND}
    },
    {
    .iv = 255,
    .lvl = 42,
    ...
    .heldItem = ITEM_LEFTOVERS,
	.ability = 0,
    .moves = {MOVE_HEAL_BELL, MOVE_RECOVER, MOVE_PSYCHIC, MOVE_YAWN}
    },
    {
    .iv = 255,
    .lvl = 42,
    ...
    .heldItem = ITEM_FOCUS_BAND,
	.ability = 0,
    .moves = {MOVE_PROTECT, MOVE_ICE_PUNCH, MOVE_PSYCHIC, MOVE_SOLAR_BEAM}
    },
    {
    .iv = 255,
    .lvl = 42,
	...
	.ability = 0,
    .moves = {MOVE_SOLAR_BEAM, MOVE_ROCK_SLIDE, MOVE_EARTHQUAKE, MOVE_REST}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Juan1[] = {
    ...
    .heldItem = ITEM_FOCUS_BAND,
	.ability = 0,
    .moves = {MOVE_HYDRO_PUMP, MOVE_THUNDERBOLT, MOVE_ICE_BEAM, MOVE_SOLAR_BEAM}
    },
    {
    .iv = 255,
    .lvl = 41,
    ...
    .heldItem = ITEM_LEFTOVERS,
	.ability = 0,
    .moves = {MOVE_TOXIC, MOVE_WATER_PULSE, MOVE_PROTECT, MOVE_EARTHQUAKE}
    },
    {
    .iv = 255,
    .lvl = 44,
    ...
    .heldItem = ITEM_CHESTO_BERRY,
	.ability = 0,
    .moves = {MOVE_ENCORE, MOVE_BODY_SLAM, MOVE_REST, MOVE_WATER_PULSE}
    },
    {
    .iv = 255,
    .lvl = 43,
    ...
    .heldItem = ITEM_LUM_BERRY,
	.ability = 0,
    .moves = {MOVE_DIVE, MOVE_CRABHAMMER, MOVE_SWORDS_DANCE, MOVE_KNOCK_OFF}
    },
    {
    .iv = 255,
    .lvl = 46,
    ...
    .heldItem = ITEM_LIFE_ORB,
	.ability = 0,
    .moves = {MOVE_WATERFALL, MOVE_DRAGON_DANCE, MOVE_OUTRAGE, MOVE_ICE_BEAM}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_AnnaAndMeg5[] = {
    ...
    .lvl = 50,
    .species = SPECIES_LINOONE,
    .moves = {MOVE_SLASH, MOVE_BELLY_DRUM, MOVE_HEADBUTT, MOVE_ODOR_SLEUTH}
    },
    {
    .iv = 40,
    .lvl = 50,
    .species = SPECIES_HARIYAMA,
    .moves = {MOVE_TACKLE, MOVE_FOCUS_ENERGY, MOVE_NONE, MOVE_NONE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Wallace[] = {
    ...
    .heldItem = ITEM_CHOICE_SCARF,
	.ability = 0,
    .moves = {MOVE_ICE_BEAM, MOVE_WATER_SPOUT, MOVE_HYDRO_PUMP, MOVE_EXPLOSION}
    },
    {
    .iv = 255,
    .lvl = 61,
    ...
    .heldItem = ITEM_LEFTOVERS,
	.ability = 0,
    .moves = {MOVE_TOXIC, MOVE_WATER_PULSE, MOVE_SLUDGE_BOMB, MOVE_ICE_BEAM}
    },
    {
    .iv = 255,
    .lvl = 62,
    ...
    .iv = 255,
    .lvl = 61,
	.evs = {248, 0, 216, 0, 44, 0},
    .species = SPECIES_SWAMPERT,
    .heldItem = ITEM_LEFTOVERS,
	.ability = 0,
    .moves = {MOVE_EARTHQUAKE, MOVE_TOXIC, MOVE_ROAR, MOVE_ICE_BEAM}
    },
    {
    .iv = 255,
    .lvl = 61,
    ...
    .heldItem = ITEM_CELL_BATTERY,
	.ability = 0,
    .moves = {MOVE_DRAGON_DANCE, MOVE_EARTHQUAKE, MOVE_ROCK_SLIDE, MOVE_WATERFALL}
    },
    {
    .iv = 255,
    .lvl = 63,
...
static const struct TrainerMonNoItemCustomMoves sParty_Becky[] = {
    ...
    .lvl = 62,
    .species = SPECIES_SANDSLASH,
    .moves = {MOVE_SWORDS_DANCE, MOVE_GUILLOTINE, MOVE_RAPID_SPIN, MOVE_EARTHQUAKE}
    },
    {
    .iv = 0,
    .lvl = 62,
    .species = SPECIES_AZUMARILL,
    .moves = {MOVE_DIVE, MOVE_DOUBLE_EDGE, MOVE_WATERFALL, MOVE_BELLY_DRUM}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_WallyVR1[] = {
    ...
    .lvl = 46,
    .species = SPECIES_AZUMARILL,
    .moves = {MOVE_BELLY_DRUM, MOVE_DIVE, MOVE_WATERFALL, MOVE_SUPERPOWER}
    },
    {
    .iv = 150,
    .lvl = 47,
...
static const struct TrainerMonItemCustomMoves sParty_WallyVR5[] = {
    ...
    .heldItem = ITEM_LEFTOVERS,
	.ability = 0,
    .moves = {MOVE_AERIAL_ACE, MOVE_EARTHQUAKE, MOVE_DRAGON_CLAW, MOVE_DRAGON_DANCE}
    },
    {
    .iv = 255,
    .lvl = 85,
    ...
    .heldItem = ITEM_EVERSTONE,
	.ability = 0,
    .moves = {MOVE_PROTECT, MOVE_LEECH_SEED, MOVE_GIGA_DRAIN, MOVE_TOXIC}
    },
    {
    .iv = 255,
    .lvl = 83,
    ...
    .heldItem = ITEM_LIFE_ORB,
	.ability = 1,
    .moves = {MOVE_SPARK, MOVE_THUNDERBOLT, MOVE_TRI_ATTACK, MOVE_MIRROR_COAT}
    },
    {
    .iv = 255,
    .lvl = 88,
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne2[] = {
	...
	.ability = 0,
    .moves = {MOVE_TRIPLE_KICK, MOVE_ROCK_SLIDE, MOVE_RAPID_SPIN, MOVE_MACH_PUNCH}
    },
    {
    .iv = 0,
    .lvl = 87,
	...
	.heldItem = ITEM_LEFTOVERS,
	.ability = 0,
    .moves = {MOVE_MEGA_PUNCH, MOVE_BULK_UP, MOVE_ICE_BEAM, MOVE_DIVE}
    },
    {
    .iv = 0,
    .lvl = 86,
	.evs = {0, 252, 0, 252, 0, 0},
    .species = SPECIES_HITMONCHAN,
    .heldItem = ITEM_COMBAT_VEST,
	.ability = 0,
    .moves = {MOVE_MEGA_PUNCH, MOVE_MACH_PUNCH, MOVE_RAPID_SPIN, MOVE_KNOCK_OFF}
    },
    {
    .iv = 0,
    .lvl = 88,
	.evs = {152, 252, 100, 0, 0, 0},
    .species = SPECIES_MACHAMP,
    .heldItem = ITEM_FLAME_ORB,
	.ability = 0,
    .moves = {MOVE_DYNAMIC_PUNCH, MOVE_FACADE, MOVE_KNOCK_OFF, MOVE_PROTECT}
    },
    {
    .iv = 0,
    .lvl = 87,
    ...
    .heldItem = ITEM_NONE,
	.ability = 0,
    .moves = {MOVE_BULK_UP, MOVE_HI_JUMP_KICK, MOVE_KNOCK_OFF, MOVE_STRENGTH}
    },
    {
    .iv = 0,
    .lvl = 86,
	.evs = {100, 252, 0, 0, 152, 0},
    .species = SPECIES_STEELIX,
    .heldItem = ITEM_LEFTOVERS,
	.ability = 0,
    .moves = {MOVE_ROCK_SLIDE, MOVE_FISSURE, MOVE_IRON_TAIL, MOVE_DRAGON_DANCE}
    },
};
//Agatha
static const struct TrainerMonItemCustomMoves sParty_Roxanne3[] = {
    ...
    .iv = 0,
    .lvl = 86,
	.evs = {106, 252, 0, 0, 152, 0},
    .species = SPECIES_ARBOK,
    .heldItem = ITEM_LEFTOVERS,
	.ability = 0,
    .moves = {MOVE_PURSUIT, MOVE_EARTHQUAKE, MOVE_SLUDGE_BOMB, MOVE_CRUNCH}
    },
    {
    .iv = 0,
    .lvl = 87,
	...
	.heldItem = ITEM_FOCUS_BAND,
	.ability = 0,
    .moves = {MOVE_SUPER_FANG, MOVE_TAUNT, MOVE_FRUSTRATION, MOVE_AIR_CUTTER}
    },
    {
    .iv = 0,
    .lvl = 86,
    ...
    .heldItem = ITEM_LIFE_ORB,
	.ability = 0,
    .moves = {MOVE_SLEEP_POWDER, MOVE_GIGA_DRAIN, MOVE_WEATHER_BALL, MOVE_SUNNY_DAY}
    },
    {
    .iv = 0,
    .lvl = 88,
    ...
    .heldItem = ITEM_CHOICE_SCARF,
	.ability = 0,
    .moves = {MOVE_THUNDERBOLT, MOVE_ICE_BEAM, MOVE_SHADOW_BALL, MOVE_FIRE_PUNCH}
    },
    {
    .iv = 0,
    .lvl = 87,
    ...
    .heldItem = ITEM_LEFTOVERS,
	.ability = 0,
    .moves = {MOVE_THUNDERBOLT, MOVE_SLUDGE_BOMB, MOVE_WILL_O_WISP, MOVE_PAIN_SPLIT}
    },
    {
    .iv = 0,
    .lvl = 86,
    ...
    .heldItem = ITEM_EVERSTONE,
	.ability = 0,
    .moves = {MOVE_CALM_MIND, MOVE_PSYCHIC, MOVE_THUNDERBOLT, MOVE_THUNDER_WAVE}
    },
};
//Lance
static const struct TrainerMonItemCustomMoves sParty_Roxanne4[] = {
    ...
    .iv = 0,
    .lvl = 86,
	.evs = {106, 252, 0, 152, 0, 0},
    .species = SPECIES_GYARADOS,
    .heldItem = ITEM_LEFTOVERS,
	.ability = 0,
    .moves = {MOVE_ROCK_SLIDE, MOVE_CRUNCH, MOVE_DRAGON_DANCE, MOVE_WATERFALL}
    },
    {
    .iv = 0,
    .lvl = 87,
    ...
    .heldItem = ITEM_LIFE_ORB,
	.ability = 0,
    .moves = {MOVE_HYDRO_PUMP, MOVE_ICE_BEAM, MOVE_DRAGON_BREATH, MOVE_AGILITY}
    },
    {
    .iv = 0,
    .lvl = 88,
    ...
    .heldItem = ITEM_LEFTOVERS,
	.ability = 0,
    .moves = {MOVE_DRAGON_DANCE, MOVE_EXTREME_SPEED, MOVE_DRAGON_CLAW, MOVE_THUNDERBOLT}
    },
    {
    .iv = 0,
    .lvl = 87,
    ...
    .heldItem = ITEM_CHOICE_SCARF,
	.ability = 0,
    .moves = {MOVE_FIRE_BLAST, MOVE_AIR_CUTTER, MOVE_DRAGON_BREATH, MOVE_THUNDER_PUNCH}
    },
};
...
static const struct TrainerMonItemCustomMoves sParty_Brawly2[] = {
    ...
    .heldItem = ITEM_ASSAULT_VEST,
	.ability = 0,
    .moves = {MOVE_FIRE_BLAST, MOVE_SUPERPOWER, MOVE_SUNNY_DAY, MOVE_EXTREME_SPEED}
    },
    {
    .iv = 0,
    .lvl = 87,
	...
	.heldItem = ITEM_LIFE_ORB,
	.ability = 0,
    .moves = {MOVE_SLEEP_POWDER, MOVE_SOLAR_BEAM, MOVE_PSYCHIC, MOVE_GIGA_DRAIN}
    },
    {
    .iv = 0,
    .lvl = 86,
    ...
    .heldItem = ITEM_LUM_BERRY,
	.ability = 0,
    .moves = {MOVE_ROCK_SLIDE, MOVE_DRAGON_DANCE, MOVE_WATERFALL, MOVE_DIVE}
    },
    {
    .iv = 0,
    .lvl = 88,
    ...
    .heldItem = ITEM_ASSAULT_VEST,
	.ability = 0,
    .moves = {MOVE_DYNAMIC_PUNCH, MOVE_ROCK_SLIDE, MOVE_KNOCK_OFF, MOVE_MEGA_PUNCH}
    },
    {
    .iv = 0,
    .lvl = 87,
    ...
    .heldItem = ITEM_FOCUS_BAND,
	.ability = 0,
    .moves = {MOVE_PSYCHIC, MOVE_THUNDER_PUNCH, MOVE_ICE_PUNCH, MOVE_KINESIS}
    },
    {
    .iv = 0,
    .lvl = 86,
    ...
    .heldItem = ITEM_LEFTOVERS,
	.ability = 0,
    .moves = {MOVE_ROCK_SLIDE, MOVE_EARTHQUAKE, MOVE_CRUNCH, MOVE_PURSUIT}
    },
};

static const struct TrainerMonItemCustomMoves sParty_Brawly3[] = { //Archie
	{.iv = 255, .lvl = 88, .species = SPECIES_POLITOED, .heldItem = ITEM_LEFTOVERS, .moves = {MOVE_SURF, MOVE_ICE_BEAM, MOVE_TOXIC, MOVE_PROTECT}},
    {.iv = 255, .lvl = 88, .species = SPECIES_KINGDRA, .heldItem = ITEM_LUM_BERRY, .moves = {MOVE_DRAGON_DANCE, MOVE_SURF, MOVE_HIDDEN_POWER, MOVE_ICE_BEAM}},
    {.iv = 255, .lvl = 89, .species = SPECIES_LUDICOLO, .heldItem = ITEM_LEFTOVERS, .moves = {MOVE_LEECH_SEED, MOVE_GIGA_DRAIN, MOVE_SURF, MOVE_ICE_BEAM}},
    {.iv = 255, .lvl = 89, .species = SPECIES_CLOYSTER, .heldItem = ITEM_SITRUS_BERRY, .moves = {MOVE_SPIKES, MOVE_SURF, MOVE_EXPLOSION, MOVE_ICE_BEAM}},
    {.iv = 255, .lvl = 88, .species = SPECIES_CROBAT, .heldItem = ITEM_CHOICE_BAND, .moves = {MOVE_SLUDGE_BOMB, MOVE_AERIAL_ACE, MOVE_SHADOW_BALL, MOVE_STEEL_WING}},
    {.iv = 255, .lvl = 90, .species = SPECIES_SHARPEDO, .heldItem = ITEM_CHOICE_BAND, .moves = {MOVE_HIDDEN_POWER, MOVE_CRUNCH, MOVE_SURF, MOVE_EARTHQUAKE}}
};

static const struct TrainerMonItemCustomMoves sParty_Brawly4[] = { //Maxie
	{.iv = 255, .lvl = 88, .species = SPECIES_NINETALES, .heldItem = ITEM_LEFTOVERS, .moves = {MOVE_FIRE_BLAST, MOVE_WILL_O_WISP, MOVE_CONFUSE_RAY, MOVE_ROAR}},
    {.iv = 255, .lvl = 88, .species = SPECIES_CLAYDOL, .heldItem = ITEM_LEFTOVERS, .moves = {MOVE_EARTHQUAKE, MOVE_PSYCHIC, MOVE_RAPID_SPIN, MOVE_ICE_BEAM}},
    {.iv = 255, .lvl = 89, .species = SPECIES_FLAREON, .heldItem = ITEM_CHOICE_BAND, .moves = {MOVE_RETURN, MOVE_SHADOW_BALL, MOVE_HIDDEN_POWER, MOVE_FIRE_BLAST}},
    {.iv = 255, .lvl = 89, .species = SPECIES_WEEZING, .heldItem = ITEM_LEFTOVERS, .moves = {MOVE_SLUDGE_BOMB, MOVE_WILL_O_WISP, MOVE_FIRE_BLAST, MOVE_EXPLOSION}},
    {.iv = 255, .lvl = 88, .species = SPECIES_CROBAT, .heldItem = ITEM_LUM_BERRY, .moves = {MOVE_SLUDGE_BOMB, MOVE_AERIAL_ACE, MOVE_HYPNOSIS, MOVE_CONFUSE_RAY}},
    {.iv = 255, .lvl = 90, .species = SPECIES_CAMERUPT, .heldItem = ITEM_WHITE_HERB, .moves = {MOVE_ERUPTION, MOVE_EARTHQUAKE, MOVE_FIRE_BLAST, MOVE_ROCK_SLIDE}}
};
...
static const struct TrainerMonItemCustomMoves sParty_Wattson2[] = { //Shelly
    {.iv = 255, .lvl = 88, .species = SPECIES_STARMIE, .heldItem = ITEM_LEFTOVERS, .moves = {MOVE_SURF, MOVE_THUNDERBOLT, MOVE_ICE_BEAM, MOVE_RECOVER}},
    {.iv = 255, .lvl = 88, .species = SPECIES_GOREBYSS, .heldItem = ITEM_WHITE_HERB, .moves = {MOVE_AMNESIA, MOVE_SURF, MOVE_ICE_BEAM, MOVE_AGILITY}},
    {.iv = 255, .lvl = 88, .species = SPECIES_LANTURN, .heldItem = ITEM_LEFTOVERS, .moves = {MOVE_THUNDERBOLT, MOVE_SURF, MOVE_ICE_BEAM, MOVE_THUNDER_WAVE}},
    {.iv = 255, .lvl = 89, .species = SPECIES_PELIPPER, .heldItem = ITEM_SITRUS_BERRY, .moves = {MOVE_SURF, MOVE_AERIAL_ACE, MOVE_PROTECT, MOVE_TOXIC}},
    {.iv = 255, .lvl = 89, .species = SPECIES_LANTURN, .heldItem = ITEM_LEFTOVERS, .moves = {MOVE_THUNDERBOLT, MOVE_SURF, MOVE_ICE_BEAM, MOVE_CONFUSE_RAY}},
    {.iv = 255, .lvl = 90, .species = SPECIES_MILOTIC, .heldItem = ITEM_LEFTOVERS, .moves = {MOVE_SURF, MOVE_ICE_BEAM, MOVE_RECOVER, MOVE_HYPNOSIS}}
	};

static const struct TrainerMonItemCustomMoves sParty_Wattson3[] = { //Matt
	{.iv = 255, .lvl = 88, .species = SPECIES_AZUMARILL, .heldItem = ITEM_SITRUS_BERRY, .moves = {MOVE_BELLY_DRUM, MOVE_RETURN, MOVE_BRICK_BREAK, MOVE_SURF}},
    {.iv = 255, .lvl = 88, .species = SPECIES_KINGLER, .heldItem = ITEM_CHOICE_BAND, .moves = {MOVE_RETURN, MOVE_HIDDEN_POWER, MOVE_ROCK_SLIDE, MOVE_CRABHAMMER}},
    {.iv = 255, .lvl = 88, .species = SPECIES_MUK, .heldItem = ITEM_LEFTOVERS, .moves = {MOVE_SLUDGE_BOMB, MOVE_CURSE, MOVE_EXPLOSION, MOVE_SHADOW_BALL}},
    {.iv = 255, .lvl = 89, .species = SPECIES_ARMALDO, .heldItem = ITEM_LUM_BERRY, .moves = {MOVE_SWORDS_DANCE, MOVE_ROCK_SLIDE, MOVE_EARTHQUAKE, MOVE_AERIAL_ACE}},
    {.iv = 255, .lvl = 89, .species = SPECIES_CRAWDAUNT, .heldItem = ITEM_CHOICE_BAND, .moves = {MOVE_CRABHAMMER, MOVE_SLUDGE_BOMB, MOVE_AERIAL_ACE, MOVE_SURF}},
    {.iv = 255, .lvl = 90, .species = SPECIES_WALREIN, .heldItem = ITEM_LEFTOVERS, .moves = {MOVE_SURF, MOVE_ICE_BEAM, MOVE_BODY_SLAM, MOVE_ENCORE}}
	};

static const struct TrainerMonItemCustomMoves sParty_Wattson4[] = { //Tabitha
	{.iv = 255, .lvl = 88, .species = SPECIES_TORKOAL, .heldItem = ITEM_WHITE_HERB, .moves = {MOVE_OVERHEAT, MOVE_EARTHQUAKE, MOVE_SLUDGE_BOMB, MOVE_EXPLOSION}},
    {.iv = 255, .lvl = 88, .species = SPECIES_FLAREON, .heldItem = ITEM_CHOICE_BAND, .moves = {MOVE_RETURN, MOVE_SHADOW_BALL, MOVE_IRON_TAIL, MOVE_FIRE_BLAST}},
    {.iv = 255, .lvl = 88, .species = SPECIES_RHYDON, .heldItem = ITEM_CHOICE_BAND, .moves = {MOVE_EARTHQUAKE, MOVE_ROCK_SLIDE, MOVE_MEGAHORN, MOVE_HIDDEN_POWER}},
    {.iv = 255, .lvl = 89, .species = SPECIES_MAGMAR, .heldItem = ITEM_SITRUS_BERRY, .moves = {MOVE_FIRE_BLAST, MOVE_THUNDER_PUNCH, MOVE_CROSS_CHOP, MOVE_PSYCHIC}},
    {.iv = 255, .lvl = 89, .species = SPECIES_GOLEM, .heldItem = ITEM_LUM_BERRY, .moves = {MOVE_EARTHQUAKE, MOVE_ROCK_SLIDE, MOVE_EXPLOSION, MOVE_FIRE_BLAST}},
    {.iv = 255, .lvl = 90, .species = SPECIES_ARCANINE, .heldItem = ITEM_LUM_BERRY, .moves = {MOVE_EXTREME_SPEED, MOVE_FIRE_BLAST, MOVE_IRON_TAIL, MOVE_HOWL}}
	};
...
static const struct TrainerMonItemCustomMoves sParty_Flannery2[] = { //Courtney
	{.iv = 255, .lvl = 88, .species = SPECIES_NINETALES, .heldItem = ITEM_LEFTOVERS, .moves = {MOVE_FIRE_BLAST, MOVE_WILL_O_WISP, MOVE_CONFUSE_RAY, MOVE_SAFEGUARD}},
    {.iv = 255, .lvl = 88, .species = SPECIES_CAMERUPT, .heldItem = ITEM_WHITE_HERB, .moves = {MOVE_ERUPTION, MOVE_EARTHQUAKE, MOVE_ROCK_SLIDE, MOVE_FIRE_BLAST}},
    {.iv = 255, .lvl = 88, .species = SPECIES_SOLROCK, .heldItem = ITEM_CHOICE_BAND, .moves = {MOVE_ROCK_SLIDE, MOVE_EARTHQUAKE, MOVE_SHADOW_BALL, MOVE_EXPLOSION}},
    {.iv = 255, .lvl = 89, .species = SPECIES_HOUNDOOM, .heldItem = ITEM_LUM_BERRY, .moves = {MOVE_CRUNCH, MOVE_FIRE_BLAST, MOVE_PURSUIT, MOVE_SOLAR_BEAM}},
    {.iv = 255, .lvl = 89, .species = SPECIES_BANETTE, .heldItem = ITEM_CHOICE_BAND, .moves = {MOVE_SHADOW_BALL, MOVE_RETURN, MOVE_HIDDEN_POWER, MOVE_WILL_O_WISP}},
    {.iv = 255, .lvl = 90, .species = SPECIES_BLAZIKEN, .heldItem = ITEM_SALAC_BERRY, .moves = {MOVE_FIRE_BLAST, MOVE_SKY_UPPERCUT, MOVE_SWORDS_DANCE, MOVE_ROCK_SLIDE}}
	};
...
static const struct TrainerMonItemCustomMoves sParty_Steven[] = {
    ...
    .heldItem = ITEM_LEFTOVERS,
	.ability = 0,
    .moves = {MOVE_TOXIC, MOVE_DRILL_PECK, MOVE_SPIKES, MOVE_PROTECT}
    },
    {
    .iv = 255,
    .lvl = 90,
    ...
    .heldItem = ITEM_LEFTOVERS,
	.ability = 0,
    .moves = {MOVE_REFLECT, MOVE_RAPID_SPIN, MOVE_ANCIENT_POWER, MOVE_EXPLOSION}
    },
    {
    .iv = 255,
    .lvl = 91,
    ...
    .heldItem = ITEM_LIFE_ORB,
	.ability = 0,
    .moves = {MOVE_RAPID_SPIN, MOVE_SWORDS_DANCE, MOVE_KNOCK_OFF, MOVE_ROCK_BLAST}
    },
    {
    .iv = 255,
    .lvl = 93,
    ...
    .heldItem = ITEM_CHOICE_BAND,
	.ability = 0,
    .moves = {MOVE_EARTHQUAKE, MOVE_ROCK_SLIDE, MOVE_METEOR_MASH, MOVE_EXPLOSION}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Cory2[] = {
	{.iv = 255, .lvl = 100, .species = SPECIES_FORRETRESS, .heldItem = ITEM_LUM_BERRY, .ability = 0, .moves = {MOVE_EXPLOSION, MOVE_SPIKES, MOVE_CHARGE, MOVE_PROTECT}},
    {.iv = 255, .lvl = 100, .species = SPECIES_EXEGGUTOR, .heldItem = ITEM_LEFTOVERS, .ability = 0, .moves = {MOVE_PSYCHIC, MOVE_SOLAR_BEAM, MOVE_SLEEP_POWDER, MOVE_PROTECT}},
    {.iv = 255, .lvl = 100, .species = SPECIES_SWELLOW, .heldItem = ITEM_FLAME_ORB, .ability = 0, .moves = {MOVE_FACADE, MOVE_AERIAL_ACE, MOVE_FRUSTRATION, MOVE_QUICK_ATTACK}},
    {.iv = 255, .lvl = 100, .species = SPECIES_BLISSEY, .heldItem = ITEM_LEFTOVERS, .ability = 0, .moves = {MOVE_SEISMIC_TOSS, MOVE_SOFT_BOILED, MOVE_HELPING_HAND, MOVE_PROTECT}},
    {.iv = 255, .lvl = 100, .species = SPECIES_TOGETIC, .heldItem = ITEM_LUM_BERRY, .ability = 1, .moves = {MOVE_FOLLOW_ME, MOVE_HELPING_HAND, MOVE_ENCORE, MOVE_PROTECT}},
    {.iv = 255, .lvl = 100, .species = SPECIES_DELIBIRD, .heldItem = ITEM_FOCUS_BAND, .ability = 0, .moves = {MOVE_FAKE_OUT, MOVE_ICE_BEAM, MOVE_AERIAL_ACE, MOVE_PROTECT}}
};
//Olivia
static const struct TrainerMonItemCustomMoves sParty_Cory3[] = {
	{.iv = 255, .lvl = 100, .species = SPECIES_CAMERUPT, .heldItem = ITEM_LEFTOVERS, .ability = 0, .moves = {MOVE_FLAME_WHEEL, MOVE_FISSURE, MOVE_ROCK_SLIDE, MOVE_PROTECT}},
    {.iv = 255, .lvl = 100, .species = SPECIES_NINETALES, .heldItem = ITEM_LUM_BERRY, .ability = 1, .moves = {MOVE_HEAT_WAVE, MOVE_WILL_O_WISP, MOVE_SUNNY_DAY, MOVE_PROTECT}},
    {.iv = 255, .lvl = 100, .species = SPECIES_TYPHLOSION, .heldItem = ITEM_CHOICE_SCARF, .ability = 0, .moves = {MOVE_ERUPTION, MOVE_THUNDER_PUNCH, MOVE_SHADOW_BALL, MOVE_SOLAR_BEAM}},
    {.iv = 255, .lvl = 100, .species = SPECIES_HOUNDOOM, .heldItem = ITEM_LEFTOVERS, .ability = 0, .moves = {MOVE_FAINT_ATTACK, MOVE_FIRE_BLAST, MOVE_SOLAR_BEAM, MOVE_PROTECT}},
    {.iv = 255, .lvl = 100, .species = SPECIES_MAGMAR, .heldItem = ITEM_CHARCOAL, .ability = 0, .moves = {MOVE_FIRE_BLAST, MOVE_THUNDER_PUNCH, MOVE_CROSS_CHOP, MOVE_PROTECT}},
    {.iv = 255, .lvl = 100, .species = SPECIES_FLAREON, .heldItem = ITEM_FOCUS_BAND, .ability = 1, .moves = {MOVE_BLAZE_KICK, MOVE_CRUNCH, MOVE_ROCK_SLIDE, MOVE_PROTECT}}
};
//Lauren
static const struct TrainerMonItemCustomMoves sParty_Cory4[] = {
	{.iv = 255, .lvl = 100, .species = SPECIES_FARFETCHD, .heldItem = ITEM_STICK, .ability = 0, .moves = {MOVE_FAKE_OUT, MOVE_AERIAL_ACE, MOVE_SLASH, MOVE_QUICK_ATTACK}},
    {.iv = 255, .lvl = 100, .species = SPECIES_MAROWAK, .heldItem = ITEM_THICK_CLUB, .ability = 1, .moves = {MOVE_BONEMERANG, MOVE_ICY_WIND, MOVE_PURSUIT, MOVE_PROTECT}},
    {.iv = 255, .lvl = 100, .species = SPECIES_HITMONCHAN, .heldItem = ITEM_LUCKY_PUNCH, .ability = 0, .moves = {MOVE_FIRE_PUNCH, MOVE_ROCK_SLIDE, MOVE_MACH_PUNCH, MOVE_PROTECT}},
    {.iv = 255, .lvl = 100, .species = SPECIES_SCYTHER, .heldItem = ITEM_CHOICE_BAND, .ability = 0, .moves = {MOVE_AERIAL_ACE, MOVE_SILVER_WIND, MOVE_FRUSTRATION, MOVE_STEEL_WING}},
    {.iv = 255, .lvl = 100, .species = SPECIES_METAGROSS, .heldItem = ITEM_LUM_BERRY, .ability = 0, .moves = {MOVE_METEOR_MASH, MOVE_EXTRASENSORY, MOVE_ICE_PUNCH, MOVE_PROTECT}},
    {.iv = 255, .lvl = 100, .species = SPECIES_GENGAR, .heldItem = ITEM_FOCUS_BAND, .ability = 0, .moves = {MOVE_THUNDERBOLT, MOVE_SHADOW_BALL, MOVE_ICE_BEAM, MOVE_PROTECT}}
};
//Francis
static const struct TrainerMonItemCustomMoves sParty_Cory5[] = {
    {.iv = 255, .lvl = 100, .species = SPECIES_SNEASEL, .heldItem = ITEM_FOCUS_BAND, .ability = 0, .moves = {MOVE_PURSUIT, MOVE_ICE_PUNCH, MOVE_FRUSTRATION, MOVE_FAKE_OUT}},
    {.iv = 255, .lvl = 100, .species = SPECIES_NINJASK, .heldItem = ITEM_FOCUS_BAND, .ability = 0, .moves = {MOVE_AERIAL_ACE, MOVE_SWORDS_DANCE, MOVE_BATON_PASS, MOVE_SUBSTITUTE}},
    {.iv = 255, .lvl = 100, .species = SPECIES_CROBAT, .heldItem = ITEM_LEFTOVERS, .ability = 0, .moves = {MOVE_SLUDGE_BOMB, MOVE_AERIAL_ACE, MOVE_GIGA_DRAIN, MOVE_PROTECT}},
    {.iv = 255, .lvl = 100, .species = SPECIES_ABSOL, .heldItem = ITEM_LIFE_ORB, .ability = 0, .moves = {MOVE_PURSUIT, MOVE_ROCK_SLIDE, MOVE_SWORDS_DANCE, MOVE_PROTECT}},
    {.iv = 255, .lvl = 100, .species = SPECIES_SCIZOR, .heldItem = ITEM_SILVER_POWDER, .ability = 0, .moves = {MOVE_SILVER_WIND, MOVE_METAL_CLAW, MOVE_SWORDS_DANCE, MOVE_PURSUIT}},
    {.iv = 255, .lvl = 100, .species = SPECIES_SWALOT, .heldItem = ITEM_LEFTOVERS, .ability = 1, .moves = {MOVE_SLUDGE_BOMB, MOVE_ICE_BEAM, MOVE_ENCORE, MOVE_PROTECT}}
};
...
static const struct TrainerMonItemCustomMoves sParty_Red[] = {
    ...
    .heldItem = ITEM_LIGHT_BALL,
	.ability = 0,
    .moves = {MOVE_VOLT_TACKLE, MOVE_IRON_TAIL, MOVE_SURF, MOVE_SPARK}
    },
    {
    .iv = 0,
    .lvl = 87,
	...
	.heldItem = ITEM_LIFE_ORB,
	.ability = 0,
    .moves = {MOVE_CALM_MIND, MOVE_PSYCHIC, MOVE_SHADOW_BALL, MOVE_BATON_PASS}
    },
    {
    .iv = 0,
    .lvl = 86,
	...
	.ability = 0,
    .moves = {MOVE_EARTHQUAKE, MOVE_CURSE, MOVE_CRUNCH, MOVE_BODY_SLAM}
    },
    {
    .iv = 0,
    .lvl = 88,
    ...
    .heldItem = ITEM_LEFTOVERS,
	.ability = 0,
    .moves = {MOVE_RAZOR_LEAF, MOVE_SLEEP_POWDER, MOVE_SLUDGE_BOMB, MOVE_EARTHQUAKE}
    },
    {
    .iv = 0,
    .lvl = 87,
    ...
    .heldItem = ITEM_FOCUS_BAND,
	.ability = 0,
    .moves = {MOVE_FIRE_BLAST, MOVE_FLY, MOVE_SWORDS_DANCE, MOVE_EARTHQUAKE}
    },
    {
    .iv = 0,
    .lvl = 86,
	.evs = {100, 0, 0, 0, 152, 252},
    .species = SPECIES_BLASTOISE,
    .heldItem = ITEM_CHOICE_SCARF,
	.ability = 0,
    .moves = {MOVE_WATER_SPOUT, MOVE_ICE_BEAM, MOVE_HYDRO_PUMP, MOVE_BRICK_BREAK}
    },
};
...
static const struct TrainerMonItemCustomMoves sParty_Leaf[] = {
    ...
    .heldItem = ITEM_LEFTOVERS,
	.ability = 0,
    .moves = {MOVE_PSYCHIC, MOVE_TOXIC, MOVE_MOONLIGHT, MOVE_TRI_ATTACK}
    },
    {
    .iv = 0,
    .lvl = 87,
	...
	.heldItem = ITEM_FOCUS_BAND,
	.ability = 0,
    .moves = {MOVE_SHADOW_BALL, MOVE_ICE_PUNCH, MOVE_WILL_O_WISP, MOVE_THUNDERBOLT}
    },
    {
    .iv = 0,
    .lvl = 86,
    ...
    .heldItem = ITEM_CHOICE_SCARF,
	.ability = 0,
    .moves = {MOVE_LEAF_BLADE, MOVE_LEECH_LIFE, MOVE_SLUDGE_BOMB, MOVE_KNOCK_OFF}
    },
    {
    .iv = 0,
    .lvl = 88,
    ...
    .heldItem = ITEM_LIFE_ORB,
	.ability = 0,
    .moves = {MOVE_FIRE_BLAST, MOVE_SHADOW_BALL, MOVE_PSYCHIC, MOVE_CALM_MIND}
    },
    {
    .iv = 0,
    .lvl = 87,
    ...
    .heldItem = ITEM_LIFE_ORB,
	.ability = 0,
    .moves = {MOVE_DIZZY_PUNCH, MOVE_BRICK_BREAK, MOVE_EARTHQUAKE, MOVE_FAKE_OUT}
    },
    {
    .iv = 0,
    .lvl = 86,
    ...
    .heldItem = ITEM_LEFTOVERS,
	.ability = 0,
    .moves = {MOVE_HYDRO_PUMP, MOVE_ICE_BEAM, MOVE_FAKE_OUT, MOVE_RAPID_SPIN}
    },
};
...
static const struct TrainerMonItemCustomMoves sParty_BrendanLinkPlaceholder[] = {
{
    ...
    .ability = 0,
    .moves = {MOVE_FIRE_BLAST, MOVE_THUNDER_PUNCH, MOVE_ERUPTION, MOVE_SHADOW_BALL}
    },
    {
    .iv = 31,
    .lvl = 88,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .ability = 0,
    .moves = {MOVE_GIGA_DRAIN, MOVE_FOLLOW_ME, MOVE_REFLECT, MOVE_SYNTHESIS}
    },
    {
    .iv = 31,
    .lvl = 88,
    ...
    .ability = 0,
    .moves = {MOVE_WATERFALL, MOVE_ICE_PUNCH, MOVE_EARTHQUAKE, MOVE_DRAGON_DANCE}
    },
    {
    .iv = 31,
    .lvl = 86,
    ...
    .ability = 0,
    .moves = {MOVE_THUNDERBOLT, MOVE_FIRE_PUNCH, MOVE_THUNDER_WAVE, MOVE_COTTON_SPORE}
    },
    {
    .iv = 31,
    .lvl = 85,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .ability = 0,
    .moves = {MOVE_ROCK_SLIDE, MOVE_EARTHQUAKE, MOVE_LOW_KICK, MOVE_FLAIL}
    },
    {
    .iv = 255,
    .lvl = 93,
    ...
    .heldItem = ITEM_LUM_BERRY,
    .ability = 0,
    .moves = {MOVE_ROCK_SLIDE, MOVE_CRUNCH, MOVE_EARTHQUAKE, MOVE_FIRE_PUNCH}
    },
};
...
static const struct TrainerMonItemCustomMoves sParty_MayLinkPlaceholder[] = {
{
    ...
    .heldItem = ITEM_LEFTOVERS,
    .ability = 0,
    .moves = {MOVE_GIGA_DRAIN, MOVE_BODY_SLAM, MOVE_REFLECT, MOVE_LIGHT_SCREEN}
    },
    {
    .iv = 255,
    .lvl = 92,
    ...
    .heldItem = ITEM_SOFT_SAND,
    .ability = 0,
    .moves = {MOVE_EARTHQUAKE, MOVE_ANCIENT_POWER, MOVE_RAPID_SPIN, MOVE_ROAR}
    },
    {
    .iv = 255,
    .lvl = 92,
    ...
    .heldItem = ITEM_CHARCOAL,
    .ability = 0,
    .moves = {MOVE_EXTREME_SPEED, MOVE_FLAMETHROWER, MOVE_IRON_TAIL, MOVE_CRUNCH}
    },
    {
    .iv = 255,
    .lvl = 91,
    ...
    .heldItem = ITEM_SILVER_POWDER,
    .ability = 0,
    .moves = {MOVE_STEEL_WING, MOVE_SWORDS_DANCE, MOVE_QUICK_ATTACK, MOVE_AGILITY}
    },
    {
    .iv = 255,
    .lvl = 91,
    ...
    .ability = 0,
    .moves = {MOVE_EXTREME_SPEED, MOVE_AERIAL_ACE, MOVE_ANCIENT_POWER, MOVE_SHADOW_BALL}
    },
};
...
static const struct TrainerMonItemCustomMoves sParty_Brock[] = {
    ...
    .heldItem = ITEM_LEFTOVERS,
	.ability = 0,
    .moves = {MOVE_ROCK_SLIDE, MOVE_CRUNCH, MOVE_DRAGON_DANCE, MOVE_ICE_BEAM}
    },
    {
    .iv = 0,
    .lvl = 87,
	...
	.heldItem = ITEM_CHOICE_BAND,
	.ability = 0,
    .moves = {MOVE_ROCK_SLIDE, MOVE_RAPID_SPIN, MOVE_EARTHQUAKE, MOVE_EXPLOSION}
    },
    {
    .iv = 0,
    .lvl = 86,
    ...
    .heldItem = ITEM_LUM_BERRY,
	.ability = 0,
    .moves = {MOVE_ROCK_SLIDE, MOVE_SWORDS_DANCE, MOVE_BRICK_BREAK, MOVE_KNOCK_OFF}
    },
    {
    .iv = 0,
    .lvl = 88,
...
static const struct TrainerMonItemCustomMoves sParty_Lorelei[] = {
    ...
    .iv = 0,
    .lvl = 86,
	.evs = {106, 0, 252, 0, 152, 0},
    .species = SPECIES_DEWGONG,
    .heldItem = ITEM_LEFTOVERS,
	.ability = 0,
    .moves = {MOVE_PROTECT, MOVE_TOXIC, MOVE_WATER_PULSE, MOVE_ICE_BEAM}
    },
    {
    .iv = 0,
    .lvl = 87,
	...
	.heldItem = ITEM_QUICK_CLAW,
	.ability = 0,
    .moves = {MOVE_PSYCHIC, MOVE_FLAMETHROWER, MOVE_SLACK_OFF, MOVE_SURF}
    },
    {
    .iv = 0,
    .lvl = 86,
    ...
    .heldItem = ITEM_CHOICE_BAND,
	.ability = 0,
    .moves = {MOVE_ROCK_BLAST, MOVE_SPIKE_CANNON, MOVE_ICICLE_SPEAR, MOVE_DIVE}
    },
    {
    .iv = 0,
    .lvl = 88,
    ...
    .heldItem = ITEM_FOCUS_BAND,
	.ability = 0,
    .moves = {MOVE_PSYCHIC, MOVE_ICE_BEAM, MOVE_CALM_MIND, MOVE_LOVELY_KISS}
    },
    {
    .iv = 0,
    .lvl = 87,
    ...
    .heldItem = ITEM_WHITE_HERB,
	.ability = 0,
    .moves = {MOVE_SHEER_COLD, MOVE_THUNDERBOLT, MOVE_SURF, MOVE_ICE_BEAM}
    },
    {
    .iv = 0,
    .lvl = 86,
    ...
    .heldItem = ITEM_LIFE_ORB,
	.ability = 0,
    .moves = {MOVE_ROCK_SLIDE, MOVE_EARTHQUAKE, MOVE_REST, MOVE_POWDER_SNOW}
    },
};
...
static const struct TrainerMonItemCustomMoves sParty_Misty[] = {
    ...
    .heldItem = ITEM_LEFTOVERS,
	.ability = 0,
    .moves = {MOVE_WATERFALL, MOVE_EARTHQUAKE, MOVE_RAIN_DANCE, MOVE_TOXIC}
    },
    {
    .iv = 0,
    .lvl = 87,
	...
	.heldItem = ITEM_LIFE_ORB,
	.ability = 0,
    .moves = {MOVE_PSYCHIC, MOVE_ICE_BEAM, MOVE_THUNDERBOLT, MOVE_RAPID_SPIN}
    },
    {
    .iv = 0,
    .lvl = 86,
    ...
    .heldItem = ITEM_WHITE_HERB,
	.ability = 0,
    .moves = {MOVE_BLIZZARD, MOVE_THUNDERBOLT, MOVE_SURF, MOVE_SHEER_COLD}
    },
    {
    .iv = 0,
    .lvl = 88,
	.evs = {152, 0, 100, 0, 0, 252},
    .species = SPECIES_LANTURN,
    .heldItem = ITEM_ASSAULT_VEST,
	.ability = 0,
    .moves = {MOVE_THUNDERBOLT, MOVE_WATER_PULSE, MOVE_SPARK, MOVE_ICE_BEAM}
    },
    {
    .iv = 0,
    .lvl = 87,
    ...
    .heldItem = ITEM_LEFTOVERS,
	.ability = 0,
    .moves = {MOVE_REST, MOVE_HYDRO_PUMP, MOVE_ICE_BEAM, MOVE_SLEEP_TALK}
    },
    {
    .iv = 0,
    .lvl = 86,
    ...
    .heldItem = ITEM_LEFTOVERS,
	.ability = 0,
    .moves = {MOVE_CALM_MIND, MOVE_WATER_PULSE, MOVE_TOXIC, MOVE_PROTECT}
    },
};

static const struct TrainerMonItemCustomMoves sParty_Surge[] = {
    {
    .iv = 0,
    .lvl = 86,
    .evs = {0, 0, 0, 252, 6, 252},
    ...
    .ability = 0,
    .moves = {MOVE_THUNDERBOLT, MOVE_CHARGE, MOVE_SHADOW_BALL, MOVE_PROTECT}
    },
    {
    .iv = 0,
    .lvl = 86,
    ...
    .ability = 0,
    .moves = {MOVE_THUNDERBOLT, MOVE_MIRROR_COAT, MOVE_TRI_ATTACK, MOVE_THUNDER_WAVE}
    },
    {
    .iv = 0,
    .lvl = 87,
    ...
    .heldItem = ITEM_ASSAULT_VEST,
    .ability = 0,
    .moves = {MOVE_THUNDERBOLT, MOVE_DRAGON_BREATH, MOVE_ANCIENT_POWER, MOVE_FLASH}
    },
    {
    .iv = 0,
    .lvl = 86,
    ...
    .heldItem = ITEM_LIFE_ORB,
    .ability = 0,
    .moves = {MOVE_THUNDERBOLT, MOVE_FLAMETHROWER, MOVE_CHARGE, MOVE_CRUNCH}
    },
    {
    .iv = 0,
    .lvl = 88,
    ...
    .heldItem = ITEM_LIGHT_BALL,
    .ability = 0,
    .moves = {MOVE_VOLT_TACKLE, MOVE_SURF, MOVE_IRON_TAIL, MOVE_FAKE_OUT}
    },
};
...
static const struct TrainerMonItemCustomMoves sParty_Erika[] = {
    ...
    .heldItem = ITEM_FOCUS_BAND,
    .ability = 0,
    .moves = {MOVE_LEECH_LIFE, MOVE_SLUDGE_BOMB, MOVE_SLEEP_POWDER, MOVE_SWORDS_DANCE}
    },
    {
    .iv = 0,
    .lvl = 86,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .ability = 0,
    .moves = {MOVE_GIGA_DRAIN, MOVE_SLUDGE_BOMB, MOVE_MOONLIGHT, MOVE_AROMATHERAPY}
    },
    {
    .iv = 0,
    .lvl = 87,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .ability = 0,
    .moves = {MOVE_SOLAR_BEAM, MOVE_GIGA_DRAIN, MOVE_HEAT_WAVE, MOVE_SYNTHESIS}
    },
    {
    .iv = 0,
    .lvl = 87,
    ...
    .heldItem = ITEM_EVERSTONE,
    .ability = 0,
    .moves = {MOVE_SLUDGE_BOMB, MOVE_GIGA_DRAIN, MOVE_SHADOW_BALL, MOVE_SPIKES}
    },
    {
    .iv = 0,
    .lvl = 88,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .ability = 0,
    .moves = {MOVE_PSYCHIC, MOVE_SOLAR_BEAM, MOVE_SLEEP_POWDER, MOVE_SUNNY_DAY}
    },
};
...
static const struct TrainerMonItemCustomMoves sParty_Koga[] = {
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .ability = 0,
    .moves = {MOVE_SLUDGE_BOMB, MOVE_AERIAL_ACE, MOVE_CONFUSE_RAY, MOVE_TOXIC}
    },
    {
    .iv = 0,
    .lvl = 86,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .ability = 0,
    .moves = {MOVE_SLUDGE_BOMB, MOVE_FIRE_PUNCH, MOVE_MINIMIZE, MOVE_CURSE}
    },
    {
    .iv = 0,
    .lvl = 87,
    ...
    .ability = 0,
    .moves = {MOVE_SILVER_WIND, MOVE_SLUDGE_BOMB, MOVE_PSYCHIC, MOVE_SLEEP_POWDER}
    },
    {
    .iv = 0,
    .lvl = 87,
    ...
    .heldItem = ITEM_LUM_BERRY,
    .ability = 0,
    .moves = {MOVE_EARTHQUAKE, MOVE_SLUDGE_BOMB, MOVE_ICE_BEAM, MOVE_THRASH}
    },
    {
    .iv = 0,
    .lvl = 86,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .ability = 0,
    .moves = {MOVE_SURF, MOVE_SLUDGE_BOMB, MOVE_BARRIER, MOVE_MIRROR_COAT}
    },
    {
    .iv = 0,
    .lvl = 88,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .ability = 0,
    .moves = {MOVE_SLUDGE_BOMB, MOVE_WILL_O_WISP, MOVE_FIRE_BLAST, MOVE_EXPLOSION}
    },
};
...
static const struct TrainerMonItemCustomMoves sParty_Sabrina[] = {
    ...
    .heldItem = ITEM_BRIGHT_POWDER,
    .ability = 0,
    .moves = {MOVE_PSYCHIC, MOVE_BITE, MOVE_MORNING_SUN, MOVE_CALM_MIND}
    },
    {
    .iv = 0,
    .lvl = 86,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .ability = 0,
    .moves = {MOVE_REFLECT, MOVE_LIGHT_SCREEN, MOVE_PSYCHIC, MOVE_ENCORE}
    },
    {
    .iv = 0,
    .lvl = 87,
...
static const struct TrainerMonItemCustomMoves sParty_Blaine[] = {
    ...
    .heldItem = ITEM_CHARCOAL,
    .ability = 1,
    .moves = {MOVE_FIRE_BLAST, MOVE_WILL_O_WISP, MOVE_CONFUSE_RAY, MOVE_SUNNY_DAY}
    },
    {
    .iv = 0,
    .lvl = 86,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .ability = 0,
    .moves = {MOVE_FIRE_BLAST, MOVE_SHADOW_BALL, MOVE_IRON_TAIL, MOVE_QUICK_ATTACK}
    },
    {
    .iv = 0,
    .lvl = 87,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .ability = 0,
    .moves = {MOVE_FIRE_BLAST, MOVE_THUNDER_PUNCH, MOVE_SUNNY_DAY, MOVE_CONFUSE_RAY}
    },
    {
    .iv = 0,
    .lvl = 86,
    ...
    .heldItem = ITEM_WHITE_HERB,
    .ability = 0,
    .moves = {MOVE_EXTREME_SPEED, MOVE_FLAMETHROWER, MOVE_IRON_TAIL, MOVE_OVERHEAT}
    },
};
...
static const struct TrainerMonItemCustomMoves sParty_Giovanni[] = {
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .ability = 0,
    .moves = {MOVE_EARTHQUAKE, MOVE_SLUDGE_BOMB, MOVE_SUPERSONIC, MOVE_CRUNCH}
    },
    {
    .iv = 0,
    .lvl = 87,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .ability = 0,
    .moves = {MOVE_EARTHQUAKE, MOVE_ERUPTION, MOVE_ROCK_SLIDE, MOVE_SUNNY_DAY}
    },
    {
    .iv = 0,
    .lvl = 86,
    ...
    .heldItem = ITEM_CHOICE_BAND,
    .ability = 0,
    .moves = {MOVE_EARTHQUAKE, MOVE_ROCK_SLIDE, MOVE_SLASH, MOVE_AERIAL_ACE}
    },
    {
    .iv = 0,
    .lvl = 88,
    ...
    .ability = 0,
    .moves = {MOVE_BONEMERANG, MOVE_ROCK_SLIDE, MOVE_DOUBLE_EDGE, MOVE_SWORDS_DANCE}
    },
};
...
static const struct TrainerMonItemCustomMoves sParty_BrendanPostgameTreecko[] = {
    {
    .iv = 255, // Max IVs for all stats
    .lvl = 85,
    .species = SPECIES_SWELLOW,
    .heldItem = ITEM_FLAME_ORB, // To trigger Guts immediately
    .moves = {MOVE_FACADE, MOVE_AERIAL_ACE, MOVE_FRUSTRATION, MOVE_PROTECT}
    },
    {
    .iv = 255,
    .lvl = 86,
    .species = SPECIES_BRELOOM,
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_SPORE, MOVE_BULLET_SEED, MOVE_MACH_PUNCH, MOVE_ROCK_TOMB} // HP Ghost
    },
    {
    .iv = 255,
    .lvl = 85,
    .species = SPECIES_WAILORD,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_SELF_DESTRUCT, MOVE_DIVE, MOVE_EARTHQUAKE, MOVE_SLACK_OFF}
    },
    {
    .iv = 255,
    .lvl = 85,
    .species = SPECIES_BEAUTIFLY,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_STUN_SPORE, MOVE_GIGA_DRAIN, MOVE_SHADOW_BALL, MOVE_AERIAL_ACE}
    },
    {
    .iv = 255,
    .lvl = 86,
    .species = SPECIES_RAICHU,
    .heldItem = ITEM_MAGNET,
    .moves = {MOVE_THUNDERBOLT, MOVE_ENCORE, MOVE_SUBSTITUTE, MOVE_SURF}
    },
    {
    .iv = 255,
    .lvl = 88,
    ...
    .moves = {MOVE_BLAZE_KICK, MOVE_MACH_PUNCH, MOVE_SOLAR_BEAM, MOVE_SWORDS_DANCE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_BrendanPostgameTorchic[] = {
    ...
    .species = SPECIES_SWELLOW,
    .heldItem = ITEM_CHOICE_BAND,
    .moves = {MOVE_FACADE, MOVE_AERIAL_ACE, MOVE_FRUSTRATION, MOVE_QUICK_ATTACK},
    },
    {
    .iv = 255,
    .lvl = 86,
    .species = SPECIES_BRELOOM,
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_SPORE, MOVE_BULLET_SEED, MOVE_MACH_PUNCH, MOVE_ROCK_SLIDE},
    },
    {
    .iv = 255,
    .lvl = 85,
    .species = SPECIES_TORKOAL,
    .heldItem = ITEM_WHITE_HERB,
    .moves = {MOVE_OVERHEAT, MOVE_EARTHQUAKE, MOVE_SLUDGE_BOMB, MOVE_EXPLOSION},
    },
    {
    .iv = 255,
    .lvl = 85,
    .species = SPECIES_BEAUTIFLY,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_STUN_SPORE, MOVE_GIGA_DRAIN, MOVE_SHADOW_BALL, MOVE_SILVER_WIND},
    },
    {
    .iv = 255,
    .lvl = 86,
...
static const struct TrainerMonItemCustomMoves sParty_BrendanPostgameMudkip[] = {
    ...
    .species = SPECIES_BRELOOM,
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_SPORE, MOVE_FOCUS_PUNCH, MOVE_MACH_PUNCH, MOVE_ROCK_SLIDE},
    },
    {
    .iv = 255,
    .lvl = 85,
    ...
    .species = SPECIES_SCEPTILE,
    .heldItem = ITEM_PETAYA_BERRY,
    .moves = {MOVE_LEAF_BLADE, MOVE_THUNDER_PUNCH, MOVE_DRAGON_CLAW, MOVE_SUBSTITUTE},
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_MayPostgameMudkip[] = {
    ...
    .species = SPECIES_MAGCARGO,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_RECOVER, MOVE_TOXIC, MOVE_FIRE_BLAST, MOVE_REFLECT}
    },
    {
    .iv = 255,
    .lvl = 85,
    ...
    .species = SPECIES_BEAUTIFLY,
    .heldItem = ITEM_SILVER_POWDER,
    .moves = {MOVE_SILVER_WIND, MOVE_GIGA_DRAIN, MOVE_PSYCHIC, MOVE_SLEEP_POWDER}
    },
    {
    .iv = 255,
    .lvl = 86,
    .species = SPECIES_RAICHU,
    .heldItem = ITEM_LIGHT_BALL,
    .moves = {MOVE_THUNDERBOLT, MOVE_SURF, MOVE_THUNDER_WAVE, MOVE_IRON_TAIL}
    },
    {
    .iv = 255,
    .lvl = 88,
    .species = SPECIES_SCEPTILE,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_LEAF_BLADE, MOVE_SUBSTITUTE, MOVE_LEECH_SEED, MOVE_THUNDER_PUNCH}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_MayPostgameTreecko[] = {
    ...
    .species = SPECIES_BRELOOM,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_SPORE, MOVE_LEECH_SEED, MOVE_SUBSTITUTE, MOVE_FOCUS_PUNCH},
    },
    {
    .iv = 255,
    .lvl = 85,
    ...
    .species = SPECIES_RAICHU,
    .heldItem = ITEM_LIGHT_BALL,
    .moves = {MOVE_THUNDERBOLT, MOVE_SURF, MOVE_IRON_TAIL, MOVE_THUNDER_WAVE},
    },
    {
    .iv = 255,
    .lvl = 88,
    .species = SPECIES_BLAZIKEN,
    .heldItem = ITEM_CHOICE_BAND,
    .moves = {MOVE_SKY_UPPERCUT, MOVE_ROCK_SLIDE, MOVE_FIRE_BLAST, MOVE_EARTHQUAKE},
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_MayPostgameTorchic[] = {
    ...
    .species = SPECIES_MAGCARGO,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_RECOVER, MOVE_TOXIC, MOVE_FIRE_BLAST, MOVE_AMNESIA},
    },
    {
    .iv = 255,
    .lvl = 85,
    ...
    .species = SPECIES_SWAMPERT,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_EARTHQUAKE, MOVE_MUDDY_WATER, MOVE_ICE_BEAM, MOVE_TOXIC},
    }
};
