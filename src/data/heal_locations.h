static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_FALLARBOR_TOWN - 1] = {MAP_GROUP(FALLARBOR_TOWN), MAP_NUM(FALLARBOR_TOWN), 22, 8},
    ...
    [HEAL_LOCATION_SOUTHERN_ISLAND_EXTERIOR - 1] = {MAP_GROUP(SOUTHERN_ISLAND_EXTERIOR), MAP_NUM(SOUTHERN_ISLAND_EXTERIOR), 17, 16},
    ...
    [HEAL_LOCATION_ONE_ISLAND - 1] = {MAP_GROUP(ONE_ISLAND), MAP_NUM(ONE_ISLAND), 14, 7},
    [HEAL_LOCATION_TWO_ISLAND - 1] = {MAP_GROUP(TWO_ISLAND), MAP_NUM(TWO_ISLAND), 21, 7},
    ...
    [HEAL_LOCATION_FIVE_ISLAND - 1] = {MAP_GROUP(FIVE_ISLAND), MAP_NUM(FIVE_ISLAND), 16, 7},
    [HEAL_LOCATION_SIX_ISLAND - 1] = {MAP_GROUP(SIX_ISLAND), MAP_NUM(SIX_ISLAND), 11, 12},
    [HEAL_LOCATION_SEVEN_ISLAND - 1] = {MAP_GROUP(SEVEN_ISLAND), MAP_NUM(SEVEN_ISLAND), 12, 9},
    ...
    [HEAL_LOCATION_FARAWAY_ISLAND - 1] = {MAP_GROUP(FARAWAY_ISLAND_ENTRANCE), MAP_NUM(FARAWAY_ISLAND_ENTRANCE), 17, 27},
    [HEAL_LOCATION_NAVAL_ROCK - 1] = {MAP_GROUP(NAVEL_ROCK_EXTERIOR), MAP_NUM(NAVEL_ROCK_EXTERIOR), 10, 13},
    [HEAL_LOCATION_BIRTH_ISLAND - 1] = {MAP_GROUP(BIRTH_ISLAND_EXTERIOR), MAP_NUM(BIRTH_ISLAND_EXTERIOR), 15, 16},
    [HEAL_LOCATION_INDIGO_PLATEAU - 1] = {MAP_GROUP(INDIGO_PLATEAU), MAP_NUM(INDIGO_PLATEAU), 11, 6},
};
