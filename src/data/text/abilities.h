...
static const u8 sStenchDescription[] = _("Badly poisons on contact.");
...
static const u8 sBattleArmorDescription[] = _("Stops criticals. +20% Def.");
static const u8 sSturdyDescription[] = _("Negates 1-hit KO attacks.");
static const u8 sDampDescription[] = _("Stops burn and explosion.");
static const u8 sLimberDescription[] = _("Prevents paralysis.");
static const u8 sSandVeilDescription[] = _("Ups attack in a sandstorm.");
...
static const u8 sObliviousDescription[] = _("Prevents attr./stat drop.");
...
static const u8 sFlashFireDescription[] = _("+30% power if hit by fire.");
...
static const u8 sWonderGuardDescription[] = _("Effective attacks only.");
...
static const u8 sSynchronizeDescription[] = _("Pass/Heal status problems.");
...
static const u8 sLightningRodDescription[] = _("+30% power if hit by elec.");
...
static const u8 sIlluminateDescription[] = _("20% to self/ally's acc.");
static const u8 sTraceDescription[] = _("Copies special ability.");
static const u8 sHugePowerDescription[] = _("Doubles total ATTACK stat.");
...
static const u8 sMagmaArmorDescription[] = _("Ice and water protection.");
static const u8 sWaterVeilDescription[] = _("Stops burns. +20% Sp.Def.");
...
static const u8 sRainDishDescription[] = _("Heals HP & status in rain.");
...
static const u8 sEarlyBirdDescription[] = _("Absorbs flying damage.");
...
static const u8 sKeenEyeDescription[] = _("Raises accuracy by 30%.");
...
static const u8 sHustleDescription[] = _("+50% damage. -20% accuracy.");
static const u8 sCuteCharmDescription[] = _("Infatuates on contact.");
static const u8 sPlusDescription[] = _("+30% sp.attack to user's team.");
static const u8 sMinusDescription[] = _("100% accuracy for all.");
...
static const u8 sLiquidOozeDescription[] = _("Absorbs poison damage.");
...
static const u8 sPurePowerDescription[] = _("Doubles total ATTACK stat.");
static const u8 sShellArmorDescription[] = _("Stops criticals. +20% Def.");
static const u8 sAirLockDescription[] = _("Negates weather effects.");
static const u8 sPermafrostDescription[] = _("Fire immune. Freezes if hit.");
static const u8 sRockBodyDescription[] = _("Absorbs rock damage.");
static const u8 sGalvanizedDescription[] = _("-30% less physical damage.");
static const u8 sSandRushDescription[] = _("Raises speed in sand.");
...
static const u8 sMultiscaleDescription[] = _("1/2 damage if full HP.");
