const u8 gMoveNames[MOVES_COUNT][MOVE_NAME_LENGTH + 1] =
{
	...
	[MOVE_FAINT_ATTACK] =_("Dark Pulse"),
	...
	[MOVE_HAIL] =_("Snowscape"),
	[MOVE_TORMENT] =_("Nasty Plot"),
