const u8 gSpeciesNames[][POKEMON_NAME_LENGTH + 1] = {
	...
	[SPECIES_OLD_UNOWN_B] =_("Annihilape"),
	[SPECIES_OLD_UNOWN_C] =_("Magnezone"),
	[SPECIES_OLD_UNOWN_D] =_("Lickilicky"),
	[SPECIES_OLD_UNOWN_E] =_("Rhyperior"),
	[SPECIES_OLD_UNOWN_F] =_("Tangrowth"),
	[SPECIES_OLD_UNOWN_G] =_("Kleavor"),
	[SPECIES_OLD_UNOWN_H] =_("Electivire"),
	[SPECIES_OLD_UNOWN_I] =_("Magmortar"),
	[SPECIES_OLD_UNOWN_J] =_("Leafeon"),
	[SPECIES_OLD_UNOWN_K] =_("Glaceon"),
	[SPECIES_OLD_UNOWN_L] =_("Dusknoir"),
	[SPECIES_OLD_UNOWN_M] =_("Porygon-Z"),
	[SPECIES_OLD_UNOWN_N] =_("Togekiss"),
	[SPECIES_OLD_UNOWN_O] =_("Ambipom"),
	[SPECIES_OLD_UNOWN_P] =_("Yanmega"),
	[SPECIES_OLD_UNOWN_Q] =_("Honchkrow"),
	[SPECIES_OLD_UNOWN_R] =_("Mismagius"),
	[SPECIES_OLD_UNOWN_S] =_("Froslass"),
	[SPECIES_OLD_UNOWN_T] =_("Gliscor"),
	[SPECIES_OLD_UNOWN_U] =_("Weavile"),
	[SPECIES_OLD_UNOWN_V] =_("Ursaluna"),
	[SPECIES_OLD_UNOWN_W] =_("Mamoswine"),
	[SPECIES_OLD_UNOWN_X] =_("Wyrdeer"),
	[SPECIES_OLD_UNOWN_Y] =_("Gallade"),
	[SPECIES_OLD_UNOWN_Z] =_("Probopass"),
