...
static const u8 sRazorWindDescription[] = _(
    "A speed-boosting move that\n"
    "strikes on the 2nd turn.");
...
static const u8 sAeroblastDescription[] = _(
    "A special attack. Blasts\n"
    "with a high crit-hit ratio.");
...
static const u8 sPowderSnowDescription[] = _(
    "Blasts the foe with swift\n"
    "shards of ice and snow.");
...
static const u8 sSacredFireDescription[] = _(
    "A physical attack. A mystic\n"
    "fire that may cause a burn.");
...
static const u8 sIngrainDescription[] = _(
    "Restores HP over time and\n"
    "weakens water and ground.");
...
static const u8 sBlazeKickDescription[] = _(
    "A speed boosting kick. High\n"
    "critical. May cause a burn.");
...
static const u8 sIceBallDescription[] = _(
    "A physical attack. Gains\n"
    "power per successive hit.");

static const u8 sNeedleArmDescription[] = _(
    "Physically hits with thorny\n"
    "arms. May cause flinching.");
