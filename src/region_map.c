...
static const u8 sMapHealLocations[][3] =
{
	...
	[MAPSEC_SAFARI_ZONE] = {MAP_GROUP(ROUTE121), MAP_NUM(ROUTE121), HEAL_LOCATION_ROUTE121},
	[MAPSEC_SOUTHERN_ISLAND] = {MAP_GROUP(SOUTHERN_ISLAND_EXTERIOR), MAP_NUM(SOUTHERN_ISLAND_EXTERIOR), HEAL_LOCATION_SOUTHERN_ISLAND_EXTERIOR},
	[MAPSEC_FARAWAY_ISLAND] = {MAP_GROUP(FARAWAY_ISLAND_ENTRANCE), MAP_NUM(FARAWAY_ISLAND_ENTRANCE), HEAL_LOCATION_FARAWAY_ISLAND},
	[MAPSEC_BIRTH_ISLAND] = {MAP_GROUP(BIRTH_ISLAND_EXTERIOR), MAP_NUM(BIRTH_ISLAND_EXTERIOR), HEAL_LOCATION_BIRTH_ISLAND},
	[MAPSEC_NAVEL_ROCK] = {MAP_GROUP(NAVEL_ROCK_EXTERIOR), MAP_NUM(NAVEL_ROCK_EXTERIOR), HEAL_LOCATION_NAVAL_ROCK},
};
...
static u8 GetMapsecType(u16 mapSecId)
{
    ...
    case MAPSEC_BATTLE_FRONTIER:
        return FlagGet(FLAG_LANDMARK_BATTLE_FRONTIER) ? MAPSECTYPE_BATTLE_FRONTIER : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_SOUTHERN_ISLAND:
        return FlagGet(FLAG_ENABLE_SHIP_SOUTHERN_ISLAND) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_BIRTH_ISLAND:
        return FlagGet(FLAG_ENABLE_SHIP_SOUTHERN_ISLAND) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_FARAWAY_ISLAND:
        return FlagGet(FLAG_ENABLE_SHIP_FARAWAY_ISLAND) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_NAVEL_ROCK:
        return FlagGet(FLAG_ENABLE_SHIP_NAVEL_ROCK) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_ONE_ISLAND:
        return FlagGet(FLAG_ENABLE_SHIP_BIRTH_ISLAND) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
